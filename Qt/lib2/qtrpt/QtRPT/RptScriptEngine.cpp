    ...
    QJSEngine(parent)
{
    ...
    this->globalObject().setProperty("Substring", wrapobj.property("funcSubstring"));
...
QString ScriptAPI::funcSubstring(QString param, int startPos, int length)
{
    return param.mid(startPos, length);
}
