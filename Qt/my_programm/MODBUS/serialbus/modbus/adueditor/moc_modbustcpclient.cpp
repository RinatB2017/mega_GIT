...
struct qt_meta_stringdata_CLASSModbusTcpClientENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSModbusTcpClientENDCLASS = QtMocHelpers::stringData(
    "ModbusTcpClient",
    "valueChanged",
    "",
    "value"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSModbusTcpClientENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ModbusTcpClient::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSModbusTcpClientENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSModbusTcpClientENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSModbusTcpClientENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<ModbusTcpClient, std::true_type>,
        // method 'valueChanged'
...
void *ModbusTcpClient::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSModbusTcpClientENDCLASS.stringdata0))
