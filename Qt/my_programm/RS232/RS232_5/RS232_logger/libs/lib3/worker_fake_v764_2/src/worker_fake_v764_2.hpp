...
**********************************************************************************/
#ifndef WORKER_FAKE_V764_2_HPP
#define WORKER_FAKE_V764_2_HPP
//--------------------------------------------------------------------------------
#include <QWidget>
#include <QTimer>
...
//--------------------------------------------------------------------------------
namespace Ui {
    class Worker_fake_v764_2;
}
//--------------------------------------------------------------------------------
class Worker_fake_v764_2 : public QWidget
{
    Q_OBJECT
...
public:
    explicit Worker_fake_v764_2(QWidget *parent = nullptr);
    virtual ~Worker_fake_v764_2();
