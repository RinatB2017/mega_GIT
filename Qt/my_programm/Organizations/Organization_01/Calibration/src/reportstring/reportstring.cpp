...
QString ReportString::prepare_report_xml(void)
{
    ...
    temp.append("        <name>report_query_UAC</name>\n");
    temp.append("        <sql>SELECT * FROM data_report_UAC</sql>\n");
    temp.append("      </querysource>\n");
    temp.append("      <querysource>\n");
    ...
    temp.append("      </querysource>\n");
    temp.append("      <querysource>\n");
    temp.append("        <name>report_query_IAC</name>\n");
    temp.append("        <sql>SELECT * FROM data_report_IAC</sql>\n");
    temp.append("      </querysource>\n");
    temp.append("      <querysource>\n");
    ...
    temp.append("      </querysource>\n");
    temp.append("      <querysource>\n");
    temp.append("        <name>report_query_R</name>\n");
    temp.append("        <sql>SELECT * FROM data_report_R</sql>\n");
    temp.append("      </querysource>\n");
    temp.append("      <querysource>\n");
    temp.append("        <name>report_query_L</name>\n");
    temp.append("        <sql>SELECT * FROM data_report_L</sql>\n");
    temp.append("      </querysource>\n");
    temp.append("      <querysource>\n");
    temp.append("        <name>report_query_FREQ</name>\n");
    temp.append("        <sql>SELECT * FROM data_report_FREQ</sql>\n");
    temp.append("      </querysource>\n");
    temp.append("      <querysource>\n");
    temp.append("        <name>report_query_C</name>\n");
    temp.append("        <sql>SELECT * FROM data_report_C</sql>\n");
    temp.append("      </querysource>\n");
    temp.append("      <querysource>\n");
    temp.append("        <name>report_query_hi_power</name>\n");
    temp.append("        <sql>SELECT * FROM data_report_hi_power</sql>\n");
    temp.append("      </querysource>\n");
    temp.append("      <querysource>\n");
    temp.append("        <name>report_query_lo_power</name>\n");
    temp.append("        <sql>SELECT * FROM data_report_lo_power</sql>\n");
    temp.append("      </querysource>\n");
    temp.append("      <querysource>\n");
    temp.append("        <name>empty_query</name>\n");
    temp.append("        <sql>SELECT * FROM data_report_EMPTY</sql>\n");
    temp.append("      </querysource>\n");
    ...
    add_section(&temp,
                ...
                tr("Проверка диапазона и основной погрешности\n"
                   "измерения напряжения переменного тока в точках:"),
                "1.3.1",
                "4.8",
                tr("Допускаемое значение\n"
                   "основной погрешности, +/-"),
    ...
    add_section(&temp,
                ...
                "my_section_IAC",
                tr("Проверка диапазона и основной погрешности\n"
                   "измерения силы переменного тока в точках:"),
                "1.3.1",
                "4.10",
                tr("Допускаемое значение\n"
                   "основной погрешности, +/-"),
    ...
    add_section(&temp,
                ...
                "my_section_R",
                tr("Проверка диапазона и основной погрешности\n"
                   "измерения сопротивления в точках:"),
                "1.3.1",
                "4.9",
                tr("Допускаемое значение\n"
                   "основной погрешности, +/-"),
    ...
    add_section(&temp,
                ...
                "my_section_FREQ",
                tr("Проверка диапазона и основной погрешности\n"
                   "измерения частоты в точке 100 кГц 0.5В"),
                "1.3.1",
                "4.11",
                tr("Допускаемое значение\n"
                   "основной погрешности, +/-"),
    ...
    add_section(&temp,
                ...
                "my_section_L",
                tr("Проверка диапазона и основной погрешности\n"
                   "измерения индуктивности в точках:"),
                "1.3.1",
                "4.12",
                tr("Допускаемое значение\n"
                   "основной погрешности, +/-"),
    ...
    add_section_wo_data(&temp,
                        5,
                        tr("Проверка индикации"),
                        "1.3.1",
                        "4.12",
                        tr("Соответствие ТУ"),
                        "", "", "", "", "", "");
    ...
    add_section_wo_data(&temp,
                        5,
                        tr("Проверка интерфейса (В7-86/2)"),
                        "1.3.12",
                        "4.6",
                        tr("Соответствие ТУ"),
                        "", "", "", "", "", "");
    ...
    add_section_wo_data(&temp,
                        5,
                        tr("Проверка программных функций"),
                        "1.3.12",
                        "4.6",
                        tr("Соответствие ТУ"),
                        "", "", "", "", "", "");
    ...
    add_section(&temp,
                ...
                5,
                "my_section_hi_power",
                tr("Проверка характеристик прибора\n"
                   "при повышенном напряжении питания\n"
                   " + 4В в точках:"),
                "1.3.18",
                "4.24",
                tr("Допускаемое значение\n"
    ...
    add_section(&temp,
                ...
                tr("Допускаемое значение\n"
                   "основной погрешности, +/-"),
                tr(""), tr(""), tr(""), tr(""), tr(""), tr(""),
                "report_query_lo_power",
                true);

    add_section_wo_data(&temp,
                        10,
                        tr("Проверка конструкции, качества сборки и монтажа,\n"
                           "габаритных размеров"),
                        "1.3.30",
                        "4.45",
                        tr("Соответствие ТУ"),
    ...
    add_section_wo_data(&temp,
                        10,
                        tr("Проверка требований к комплектующим,\n"
                           "радиоэлементам"),
                        "1.3.31",
                        "4.46",
                        tr("Соответствие ТУ"),
    ...
    add_section_wo_data(&temp,
                        10,
                        tr("Проверка оставшегося срока сохраняемости,\n"
                           "комплектующих электрорадиоэлементов"),
                        "1.3.32",
                        "4.47",
                        tr("Соответствие ТУ"),
                        "", "", "", "", "", "");
    ...
    add_section_wo_data(&temp,
                        10,
                        tr("Проверка упаковки и временной\n"
...
//--------------------------------------------------------------------------------
void ReportString::add_section_wo_data(QString *data,
                                       int height_mm,
                                       const QString &text_1,
                                       const QString &text_2,
                                       const QString &text_3,
...
{
    data->append("      <section>\n");
    data->append("       <name>my_mega_section_X</name>\n");
    data->append("       <detail>\n");
    data->append("          <key>\n");
    data->append("              <query>empty_query</query>\n");
    data->append("          </key>\n");
    data->append(QString("              <height>%1</height>\n").arg(mm_to_pixels(height_mm)));
    add_text(data, 0, height_mm, text_1, text_2, text_3, text_4, text_5, text_6, text_7, text_8, text_9, text_10);
    data->append("        </detail>\n");
