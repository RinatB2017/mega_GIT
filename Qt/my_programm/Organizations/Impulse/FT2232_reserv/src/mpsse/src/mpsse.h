...
void EnableBitmode(struct mpsse_context *mpsse,
                   int tf);
int SetClock(struct mpsse_context *mpsse,
             uint32_t freq);
...
int SetLoopback(struct mpsse_context *mpsse,
                int enable);
void SetCSIdle(struct mpsse_context *mpsse,
               int idle);
...
void FlushAfterRead(struct mpsse_context *mpsse,
                    int tf);
int PinHigh(struct mpsse_context *mpsse,
            int pin);
int PinLow(struct mpsse_context *mpsse,
           int pin);
...
char ReadBits(struct mpsse_context *mpsse,
              int size);
int WritePins(struct mpsse_context *mpsse,
              uint8_t data);
