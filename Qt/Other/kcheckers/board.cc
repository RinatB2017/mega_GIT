...
void myBoard::setTheme(const QString& theme_path, bool set_white)
{
	// delete them later.
    ...
    xpmPat1 = new QPixmap(theme_path+"/"THEME_TILE1);
    xpmPat2 = new QPixmap(theme_path+"/"THEME_TILE2);
    xpmFrame= new QPixmap(theme_path+"/"THEME_FRAME);
	xpmManBlack
        = new QPixmap(theme_path+"/"THEME_MANBLACK);
	xpmManWhite
        = new QPixmap(theme_path+"/"THEME_MANWHITE);
	xpmKingBlack
        = new QPixmap(theme_path+"/"THEME_KINGBLACK);
	xpmKingWhite
        = new QPixmap(theme_path+"/"THEME_KINGWHITE);
	}
