...
**********************************************************************************/
#ifndef V764_2_MULTIMETER_HPP
#define V764_2_MULTIMETER_HPP
//--------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------
class Multimeter_V764_2 : public MyWidget
{
    Q_OBJECT

public:
    explicit Multimeter_V764_2(QWidget *parent = nullptr);
    virtual ~Multimeter_V764_2();
