/****************************************************************************
** Meta object code from reading C++ file 'test_broadcast_udp_mainbox.hpp'
**
...
#include "src/test_broadcast_udp_mainbox/test_broadcast_udp_mainbox.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'test_broadcast_udp_mainbox.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(6, 34, 4), // "test"
QT_MOC_LITERAL(7, 39, 25), // "server_thread_is_finished"
QT_MOC_LITERAL(8, 65, 25) // "client_thread_is_finished"

    },
    "MainBox\0info\0\0debug\0error\0message\0"
    "test\0server_thread_is_finished\0"
    "client_thread_is_finished"
};
...
void MainBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->server_thread_is_finished(); break;
        case 6: _t->client_thread_is_finished(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MainBox::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainBox::info)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MainBox::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainBox::debug)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (MainBox::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainBox::error)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (MainBox::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainBox::message)) {
                *result = 3;
                return;
            }
        }
