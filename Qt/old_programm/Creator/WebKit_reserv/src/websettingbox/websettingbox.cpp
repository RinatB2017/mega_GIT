...
//--------------------------------------------------------------------------------
WebSettingBox::WebSettingBox(QWidget *parent) :
    QDialog(parent)
{
    init();
}
...
void WebSettingBox::init(void)
{
    ...
    QPushButton *default_btn = new QPushButton;
    default_btn->setIcon(qApp->style()->standardIcon(QStyle::SP_DialogResetButton));
    default_btn->setText(tr("default"));
    connect(default_btn, SIGNAL(clicked()), this, SLOT(set_default()));

    QHBoxLayout *hbox = new QHBoxLayout;
    hbox->addWidget(buttonBox);
    hbox->addStretch();
    hbox->addWidget(default_btn);
...
//--------------------------------------------------------------------------------
void WebSettingBox::slot_checkbox(bool state)
{
...
void WebSettingBox::set_default(void)
{
    for(int n=0; n<attributes.count(); n++)
    {
        ...
        checkBox->setChecked(attributes[n].default_value);
    }
}
//--------------------------------------------------------------------------------
