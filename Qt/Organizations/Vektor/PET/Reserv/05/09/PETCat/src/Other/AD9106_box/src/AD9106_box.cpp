...
#endif
    //---
    connect(ui->btn_open,       SIGNAL(clicked(bool)),  this,   SLOT(dev_open()));
    //connect(ui->btn_read_all,   SIGNAL(clicked(bool)),  this,   SLOT(dev_read_all_registers()));
    connect(ui->btn_close,      SIGNAL(clicked(bool)),  this,   SLOT(dev_close()));
    //---
    connect(ui->btn_ApplySettings,  SIGNAL(clicked(bool)),  this,   SLOT(ApplySettings()));
    connect(ui->btn_StopGeneration, SIGNAL(clicked(bool)),  this,   SLOT(StopGeneration()));
    connect(ui->btn_ManualReset,    SIGNAL(clicked(bool)),  this,   SLOT(ManualReset()));
    //---
    connect(ui->btn_read_xml,       SIGNAL(clicked(bool)),  this,   SLOT(read_xml()));
    //connect(ui->btn_convert_xml,    SIGNAL(clicked(bool)),  this,   SLOT(convert_xml()));
    //---
    connect(ui->btn_set_values,     SIGNAL(clicked(bool)),  this,   SLOT(set_values()));
    //---
