...
void LogBox::init(void)
{
    ...
    MyWidget::get_param(PETCAT_OPTIONS_MAIN_GROUP,    PARAM_IS_SHOWS_INFO,    DEFAULT_PARAM_IS_SHOWS_INFO,    &v_is_shows_info);
    MyWidget::get_param(PETCAT_OPTIONS_MAIN_GROUP,    PARAM_IS_SHOWS_DEBUG,   DEFAULT_PARAM_IS_SHOWS_DEBUG,   &v_is_shows_debug);
    MyWidget::get_param(PETCAT_OPTIONS_MAIN_GROUP,    PARAM_IS_SHOWS_ERROR,   DEFAULT_PARAM_IS_SHOWS_ERROR,   &v_is_shows_error);
    MyWidget::get_param(PETCAT_OPTIONS_MAIN_GROUP,    PARAM_IS_SHOWS_TRACE,   DEFAULT_PARAM_IS_SHOWS_TRACE,   &v_is_shows_trace);
