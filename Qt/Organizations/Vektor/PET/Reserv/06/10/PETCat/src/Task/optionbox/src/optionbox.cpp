...
void OptionBox::init(void)
{
    ...
    //---
    PET_RESULT err = comm->set_comm_param(addr,
    ...
    foreach (pet_discovery_data_t d_packet, l_info)
    {
        if(d_packet.addr == PET_ADDR_ROOT)
        {
            ...
            case PET_PID_BOS:
                ...
                res = bos_page->set_comm_param(p_pet_config.at(0).host,
            ...
            case PET_PID_SIM:
                ...
                res = sim_page->set_comm_param(p_pet_config.at(0).host,
                                               p_pet_config.at(0).port);
                if(res != PET_SUCCESS)
                {
                    emit error(PET_device_base::get_PET_RESULT_string(res));
            ...
            case PET_PID_TD:
                ...
                res = td_page->set_comm_param(p_pet_config.at(0).host,
                                              p_pet_config.at(0).port);
                if(res != PET_SUCCESS)
                {
                    emit error(PET_device_base::get_PET_RESULT_string(res));
    ...
    foreach (pet_discovery_data_t d_packet, l_info)
    {
        if(d_packet.addr != PET_ADDR_ROOT)
        {
            ...
            case PET_PID_BRG:
                ...
                res = brg_page->set_comm_param(p_pet_config.at(0).host,
                                               p_pet_config.at(0).port);
                if(res != PET_SUCCESS)
                {
                    emit error(PET_device_base::get_PET_RESULT_string(res));
            ...
            case PET_PID_BRG_SIM:
                ...
                res = brg_sim_page->set_comm_param(p_pet_config.at(0).host,
                                                   p_pet_config.at(0).port);
                if(res != PET_SUCCESS)
                {
                    emit error(PET_device_base::get_PET_RESULT_string(res));
