...
#include "ui_pet_brg_main_page.h"
//--------------------------------------------------------------------------------
...
#endif
//--------------------------------------------------------------------------------
PET_brg_main_page::PET_brg_main_page(QWidget *parent, bool is_demo) :
    PET_device_brg(parent),
    ui(new Ui::PET_brg_main_page),
    flag_is_demo(is_demo)
{
    init();
}
//--------------------------------------------------------------------------------
PET_brg_main_page::~PET_brg_main_page()
{
...
//--------------------------------------------------------------------------------
void PET_brg_main_page::add_page_device_info(void)
{
...
//--------------------------------------------------------------------------------
void PET_brg_main_page::add_page_debug(void)
{
    p_brg_debug     = new PET_brg_debug_page(this);
...
//--------------------------------------------------------------------------------
void PET_brg_main_page::add_page_ch0(void)
{
...
//--------------------------------------------------------------------------------
void PET_brg_main_page::add_page_ch1(void)
{
...
//--------------------------------------------------------------------------------
void PET_brg_main_page::add_page_ch2(void)
{
...
//--------------------------------------------------------------------------------
void PET_brg_main_page::add_page_ch3(void)
{
...
//--------------------------------------------------------------------------------
void PET_brg_main_page::init(void)
{
    ui->setupUi(this);

    //TODO mark
    //---
    mark_spinbox("setting_name",        "brg_main_page");
    mark_doublespinbox("setting_name",  "brg_main_page");
    mark_combobox("setting_name",       "brg_main_page");
    //---

    ui->tabWidget->setCurrentIndex(0);

    //addr = PET_ADDR_BRG_MIN;
    channel = 0;
...
//--------------------------------------------------------------------------------
void PET_brg_main_page::btn_refresh_click(void)
{
    main_refresh();
}
//--------------------------------------------------------------------------------
void PET_brg_main_page::btn_apply_click(void)
{
    main_apply();
}
//--------------------------------------------------------------------------------
void PET_brg_main_page::btn_close_click(void)
{
    main_close();
}
//--------------------------------------------------------------------------------
void PET_brg_main_page::btn_import_click(void)
{
    f_import();
}
//--------------------------------------------------------------------------------
void PET_brg_main_page::btn_export_click(void)
{
    f_export();
}
//--------------------------------------------------------------------------------
void PET_brg_main_page::create_pages(uint8_t pet_addr)
{
    ...
    //FIXME костыль
    p_brg_debug->set_pet_addr(pet_addr);
    //---
}
//--------------------------------------------------------------------------------
void PET_brg_main_page::all_refresh(void)
{
...
//--------------------------------------------------------------------------------
void PET_brg_main_page::update_widgets(void)
{
    main_refresh();
}
//--------------------------------------------------------------------------------
//--------------------------------------------------------------------------------
void PET_brg_main_page::main_refresh(void)
{
...
//--------------------------------------------------------------------------------
void PET_brg_main_page::main_apply(void)
{
    block_this_button(true);
    channel = 0;
...
//--------------------------------------------------------------------------------
void PET_brg_main_page::main_close(void)
{
    emit error("Close");
    parentWidget()->close();
}
//--------------------------------------------------------------------------------
//--------------------------------------------------------------------------------
void PET_brg_main_page::get_packet(QByteArray packet)
{
...
//--------------------------------------------------------------------------------
PET_RESULT PET_brg_main_page::f_PET_CMD_GET_DEVICE_INFO(void)
{
...
//--------------------------------------------------------------------------------
PET_RESULT PET_brg_main_page::f_PET_CMD_GET_CONTROL(void)
{
...
//--------------------------------------------------------------------------------
PET_RESULT PET_brg_main_page::f_PET_CMD_GET_CH_CONTROL(void)
{
...
//--------------------------------------------------------------------------------
PET_RESULT PET_brg_main_page::f_PET_CMD_GET_CH_STATE(void)
{
...
//--------------------------------------------------------------------------------
PET_RESULT PET_brg_main_page::f_PET_CMD_SET_CONTROL(void)
{
...
//--------------------------------------------------------------------------------
PET_RESULT PET_brg_main_page::f_PET_CMD_SET_CH_CONTROL(void)
{
...
//--------------------------------------------------------------------------------
void PET_brg_main_page::block_this_button(bool state)
{
...
//--------------------------------------------------------------------------------
bool PET_brg_main_page::check_packet(uint8_t cmd, QByteArray packet)
{
    //emit debug(QString("check_size_packet: [%1]").arg(packet.toHex().data()));
    if(packet.length() < (int)sizeof(pet_frame_t))
    {
        emit error("PET_brg_main_page::check_size_packet: packet too small");
        return false;
    }
    ...
    {
        emit error("PET_brg_main_page::check_size_packet: bad len");
        return false;
    }
...
//--------------------------------------------------------------------------------
//FIXME костыль
void PET_brg_main_page::f_import(void)
{
    PET_device_brg::f_import();
}
void PET_brg_main_page::f_export(void)
{
    PET_device_brg::f_export();
}
//--------------------------------------------------------------------------------
