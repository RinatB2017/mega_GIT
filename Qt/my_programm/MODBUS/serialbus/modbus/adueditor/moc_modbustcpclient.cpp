...
static constexpr auto qt_meta_stringdata_ZN15ModbusTcpClientE = QtMocHelpers::stringData(
    "ModbusTcpClient",
    "valueChanged",
    "",
    "value"
...
Q_CONSTINIT static const uint qt_meta_data_ZN15ModbusTcpClientE[] = {
...
Q_CONSTINIT const QMetaObject ModbusTcpClient::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15ModbusTcpClientE.offsetsAndSizes,
    qt_meta_data_ZN15ModbusTcpClientE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15ModbusTcpClientE_t,
        // Q_OBJECT / Q_GADGET
...
void *ModbusTcpClient::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15ModbusTcpClientE.stringdata0))
