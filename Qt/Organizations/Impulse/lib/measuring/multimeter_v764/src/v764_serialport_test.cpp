...
//--------------------------------------------------------------------------------
void SerialPort_V764_test::write(QByteArray data)
{
...
{
    CMD_V764_0x45_QUESTION *question = (CMD_V764_0x45_QUESTION *)input.data();

    unsigned short crc = CRC::powersupply_crc16((unsigned char *)&question->buf, sizeof(CMD_V764_0x45_QUESTION) - 2);
...
{
    CMD_V764_0x46_QUESTION *question = (CMD_V764_0x46_QUESTION *)input.data();

    unsigned short crc = CRC::powersupply_crc16((unsigned char *)&question->buf, sizeof(CMD_V764_0x46_QUESTION) - 2);
    if(crc != question->body.crc16)
    {
#ifdef QT_DEBUG
...
{
    CMD_V764_0x47_QUESTION *question = (CMD_V764_0x47_QUESTION *)input.data();

    unsigned short crc = CRC::powersupply_crc16((unsigned char *)&question->buf, sizeof(CMD_V764_0x47_QUESTION) - 2);
    if(crc != question->body.crc16)
    {
#ifdef QT_DEBUG
...
{
    CMD_V764_0x48_QUESTION *question = (CMD_V764_0x48_QUESTION *)input.data();

    unsigned short crc = CRC::powersupply_crc16((unsigned char *)&question->buf, sizeof(CMD_V764_0x48_QUESTION) - 2);
    if(crc != question->body.crc16)
    {
#ifdef QT_DEBUG
...
{
    CMD_V764_0x53_QUESTION *question = (CMD_V764_0x53_QUESTION *)input.data();

    unsigned short crc = CRC::powersupply_crc16((unsigned char *)&question->buf, sizeof(CMD_V764_0x53_QUESTION) - 2);
    if(crc != question->body.crc16)
    {
#ifdef QT_DEBUG
...
void SerialPort_V764_test::prepare_answer_45(void)
{
    ...
    answer.body.crc16 = CRC::powersupply_crc16((unsigned char *)&answer.buf, sizeof(CMD_V764_0x45_ANSWER) - 2);

    output.clear();
    output.append((const char *)answer.buf, sizeof(CMD_V764_0x45_ANSWER));
...
void SerialPort_V764_test::prepare_answer_46(void)
{
    ...
    answer.body.crc16 = CRC::powersupply_crc16((unsigned char *)&answer.buf, sizeof(CMD_V764_0x46_ANSWER) - 2);

    output.clear();
    output.append((const char *)answer.buf, sizeof(CMD_V764_0x46_ANSWER));
...
void SerialPort_V764_test::prepare_answer_47(void)
{
    ...
    //qDebug() << QString("SerialPort_V764_test::prepare_answer_47 measuring_value %1").arg(measuring_value);
    answer.body.data.value = measuring_value * 1000;

    answer.body.crc16 = CRC::powersupply_crc16((unsigned char *)&answer.buf, sizeof(CMD_V764_0x47_ANSWER) - 2);

    output.clear();
    output.append((const char *)answer.buf, sizeof(CMD_V764_0x47_ANSWER));
...
void SerialPort_V764_test::prepare_answer_48(void)
{
    ...
    answer.body.header.count_data = sizeof(answer.body.data);
    answer.body.crc16 = CRC::powersupply_crc16((unsigned char *)&answer.buf, sizeof(CMD_V764_0x48_ANSWER) - 2);

    output.clear();
    output.append((const char *)answer.buf, sizeof(CMD_V764_0x48_ANSWER));
...
void SerialPort_V764_test::prepare_answer_53(void)
{
    ...
    answer.body.crc16 = CRC::powersupply_crc16((unsigned char *)&answer.buf, sizeof(CMD_V764_0x53_ANSWER) - 2);

    output.clear();
    output.append((const char *)answer.buf, sizeof(CMD_V764_0x53_ANSWER));
