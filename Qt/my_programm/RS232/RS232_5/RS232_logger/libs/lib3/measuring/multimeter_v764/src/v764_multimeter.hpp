...
**********************************************************************************/
#ifndef V764_MULTIMETER_HPP
#define V764_MULTIMETER_HPP
//--------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------
class Multimeter_V764 : public MyWidget
{
    Q_OBJECT

public:
    explicit Multimeter_V764(QWidget *parent = nullptr);
    virtual ~Multimeter_V764();
...
#else
    SerialPort_V764_test *serial = nullptr;
#endif
