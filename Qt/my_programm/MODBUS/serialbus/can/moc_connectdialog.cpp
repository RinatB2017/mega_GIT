...
static constexpr auto qt_meta_stringdata_ZN13ConnectDialogE = QtMocHelpers::stringData(
    "ConnectDialog",
    "pluginChanged",
    "",
    "plugin",
...
Q_CONSTINIT static const uint qt_meta_data_ZN13ConnectDialogE[] = {
...
Q_CONSTINIT const QMetaObject ConnectDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13ConnectDialogE.offsetsAndSizes,
    qt_meta_data_ZN13ConnectDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13ConnectDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void *ConnectDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13ConnectDialogE.stringdata0))
