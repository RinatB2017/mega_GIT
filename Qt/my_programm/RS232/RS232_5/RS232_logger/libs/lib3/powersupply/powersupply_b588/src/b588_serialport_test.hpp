...
**********************************************************************************/
#ifndef SERIALPORT_B588_TEST_HPP
#define SERIALPORT_B588_TEST_HPP
//--------------------------------------------------------------------------------
...
class QSpinBox;
//--------------------------------------------------------------------------------
class SerialPort_B588_test : public QObject
{
    Q_OBJECT

public:
    explicit SerialPort_B588_test();
    virtual ~SerialPort_B588_test();
...
private:
    ...
    uint16_t Value_DAC_MIN_U;
    uint16_t Value_DAC_MAX_U;

    int32_t Value_Zero_ADC_I;
    int32_t Value_delta_ADC_I;
    uint16_t Value_DAC_MIN_I;
    uint16_t Value_DAC_MAX_I;
    ...
    uint16_t dac_U[0xFFFF];
    uint16_t dac_I[0xFFFF];
