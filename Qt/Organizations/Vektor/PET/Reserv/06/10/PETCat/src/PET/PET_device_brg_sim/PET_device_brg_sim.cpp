...
#include "pet.h"
//--------------------------------------------------------------------------------
PET_device_brg_sim::PET_device_brg_sim(QWidget *parent) :
    PET_device_base(parent)
{

}
//--------------------------------------------------------------------------------
PET_device_brg_sim::~PET_device_brg_sim()
{

}
//--------------------------------------------------------------------------------
int PET_device_brg_sim::get_PID(void)
{
    return PET_PID_BRG;
}
//--------------------------------------------------------------------------------
PET_RESULT PET_device_brg_sim::test(void *i_data, int *i_data_len,
...
//--------------------------------------------------------------------------------
PET_RESULT PET_device_brg_sim::get_device_info(pet_device_info_t *data,
                                               int *data_len)
{
    Q_CHECK_PTR(data);
...
//--------------------------------------------------------------------------------
PET_RESULT PET_device_brg_sim::get_ctrl(pet_brg_ctrl_t *data, int *data_len)
{
    Q_CHECK_PTR(data);
    Q_CHECK_PTR(data_len);
...
//--------------------------------------------------------------------------------
PET_RESULT PET_device_brg_sim::get_state(pet_brg_state_t *data, int *data_len)
{
    Q_CHECK_PTR(data);
    Q_CHECK_PTR(data_len);
...
//--------------------------------------------------------------------------------
PET_RESULT PET_device_brg_sim::get_ch_ctrl(uint16_t *i_data, int *i_data_len,
...
//--------------------------------------------------------------------------------
PET_RESULT PET_device_brg_sim::get_ch_state(uint16_t *i_data, int *i_data_len,
...
//--------------------------------------------------------------------------------
#if 0
PET_RESULT PET_device_brg_sim::get_ch_statistic(pet_brg_ch_statistics_t *i_data, int *i_data_len,
                                                pet_brg_ch_statistics_t *o_data, int *o_data_len)
{
    Q_CHECK_PTR(i_data);
    Q_CHECK_PTR(i_data_len);
    Q_CHECK_PTR(o_data);
    Q_CHECK_PTR(o_data_len);
    return _get_ch_statistics(i_data, i_data_len,
                              o_data, o_data_len);
}
#endif
//--------------------------------------------------------------------------------
PET_RESULT PET_device_brg_sim::get_oscillogram(pet_wave_t *i_data, int *i_data_len,
                                               pet_wave_t *o_data, int *o_data_len)
{
    Q_CHECK_PTR(i_data);
    Q_CHECK_PTR(i_data_len);
    Q_CHECK_PTR(o_data);
...
//--------------------------------------------------------------------------------
void PET_device_brg_sim::f_import(void)
{
    QString filename;
    filename.clear();

    MyFileDialog *dlg = new MyFileDialog("filedialog_states", "brg_sim_dlg");
...
//--------------------------------------------------------------------------------
void PET_device_brg_sim::f_export(void)
{
    QString filename;
    filename.clear();
...
//--------------------------------------------------------------------------------
void PET_device_brg_sim::save_to_EEPROM(void)
{
...
//--------------------------------------------------------------------------------
void PET_device_brg_sim::set_default(void)
{
