...
//--------------------------------------------------------------------------------
Powersupply_B588::Powersupply_B588(QWidget *parent) :
    MyWidget(parent),
    is_ready(false),
    busy(false),
    address(1),
...
bool Powersupply_B588::find_device(void)
{
    ...
    foreach (const QSerialPortInfo &port, QSerialPortInfo::availablePorts())
    {
        ...
        foreach (int speed, speeds)
        {
            ...
            serial.setPort(port);
            emit debug(QString("speed %1").arg(speed));
                                      ...
                                      int max_deviation_mV)
{
    ...
    int delta = abs(result - get_voltage_mV);
...
int Powersupply_B588::print_last_error(void)
{
    ...
    case E_B588_ERROR_NO_ANSWER:            emit error(QString(tr("%1 не отвечает")).arg(POWER_SUPPLY_NAME)); break;
...
//--------------------------------------------------------------------------------
//--------------------------------------------------------------------------------
void Powersupply_B588::updateText(void)
{

}
//--------------------------------------------------------------------------------
bool Powersupply_B588::programm_is_exit(void)
{
    return true;
}
//--------------------------------------------------------------------------------
void Powersupply_B588::load_setting(void)
{

}
//--------------------------------------------------------------------------------
void Powersupply_B588::save_setting(void)
{
