...
#include "ui_page_oscilloscope_options.h"
//--------------------------------------------------------------------------------
...
#include "pet.h"
//--------------------------------------------------------------------------------
Page_oscilloscope_options::Page_oscilloscope_options(QWidget *parent) :
    MyWidget(parent),
    ui(new Ui::Page_oscilloscope_options)
{
    init();
}
//--------------------------------------------------------------------------------
Page_oscilloscope_options::~Page_oscilloscope_options()
{
    delete ui;
}
//--------------------------------------------------------------------------------
void Page_oscilloscope_options::init(void)
{
    ui->setupUi(this);
...
//--------------------------------------------------------------------------------
void Page_oscilloscope_options::t_accept(void)
{
...
//--------------------------------------------------------------------------------
void Page_oscilloscope_options::color_X_plus(void)
{
...
//--------------------------------------------------------------------------------
void Page_oscilloscope_options::color_X_minus(void)
{
    QToolButton *tb = dynamic_cast<QToolButton *>(sender());
    if(tb == nullptr)
    {
...
//--------------------------------------------------------------------------------
void Page_oscilloscope_options::color_Y_plus(void)
{
    QToolButton *tb = dynamic_cast<QToolButton *>(sender());
    if(tb == nullptr)
    {
...
//--------------------------------------------------------------------------------
void Page_oscilloscope_options::color_Y_minus(void)
{
    QToolButton *tb = dynamic_cast<QToolButton *>(sender());
    if(tb == nullptr)
    {
...
//--------------------------------------------------------------------------------
void Page_oscilloscope_options::color_SUM(void)
{
    QToolButton *tb = dynamic_cast<QToolButton *>(sender());
    if(tb == nullptr)
    {
...
//--------------------------------------------------------------------------------
void Page_oscilloscope_options::block_wheel(void)
{
...
//--------------------------------------------------------------------------------
bool Page_oscilloscope_options::eventFilter(QObject*, QEvent* event)
{
