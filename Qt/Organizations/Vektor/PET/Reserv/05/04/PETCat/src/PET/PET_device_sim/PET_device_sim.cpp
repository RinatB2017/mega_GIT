...
#include "pet.h"
//--------------------------------------------------------------------------------
PET_device_sim::PET_device_sim(QWidget *parent) :
    PET_device_base(parent)
{

}
//--------------------------------------------------------------------------------
PET_device_sim::~PET_device_sim()
{

}
//--------------------------------------------------------------------------------
int PET_device_sim::get_PID(void)
{
    return PET_PID_BOS;
}
//--------------------------------------------------------------------------------
PET_RESULT PET_device_sim::get_test(void *i_data, int *i_data_len,
...
//--------------------------------------------------------------------------------
PET_RESULT PET_device_sim::get_device_info(pet_device_info_t *data,
                                           int *data_len)
{
    Q_CHECK_PTR(data);
...
//--------------------------------------------------------------------------------
PET_RESULT PET_device_sim::get_ctrl(pet_bos_ctrl_t *data,
                                    int *data_len)
{
    Q_CHECK_PTR(data);
    Q_CHECK_PTR(data_len);
...
//--------------------------------------------------------------------------------
PET_RESULT PET_device_sim::get_state(pet_bos_state_t *data,
                                     int *data_len)
{
    Q_CHECK_PTR(data);
    Q_CHECK_PTR(data_len);
...
//--------------------------------------------------------------------------------
PET_RESULT PET_device_sim::get_ch_ctrl(uint16_t *i_data, int *i_data_len,
...
//--------------------------------------------------------------------------------
PET_RESULT PET_device_sim::get_ch_state(uint16_t *i_data, int *i_data_len,
...
//--------------------------------------------------------------------------------
void PET_device_sim::f_import(void)
{
    QString filename;
    filename.clear();

    MyFileDialog *dlg = new MyFileDialog("filedialog_states", "sim_dlg");
...
//--------------------------------------------------------------------------------
void PET_device_sim::f_export(void)
{
    QString filename;
    filename.clear();
...
//--------------------------------------------------------------------------------
void PET_device_sim::save_to_EEPROM(void)
{
...
//--------------------------------------------------------------------------------
void PET_device_sim::set_default(void)
{
