...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        horizontalSpacer = new QSpacerItem(13, 20, QSizePolicy::Policy::Maximum, QSizePolicy::Policy::Minimum);
        ...
        tcpPortLabel->setObjectName("tcpPortLabel");
        ...
        horizontalSpacer_3 = new QSpacerItem(13, 20, QSizePolicy::Policy::Maximum, QSizePolicy::Policy::Minimum);

        gridLayout->addItem(horizontalSpacer_3, 1, 0, 1, 1);

        tcpAddressEdit = new QLineEdit(settingsWidget);
        tcpAddressEdit->setObjectName("tcpAddressEdit");
        ...
        tcpAddressLabel->setObjectName("tcpAddressLabel");
        ...
        horizontalSpacer_2 = new QSpacerItem(13, 20, QSizePolicy::Policy::Maximum, QSizePolicy::Policy::Minimum);

        gridLayout->addItem(horizontalSpacer_2, 8, 0, 1, 1);

        tcpPortEdit = new QLineEdit(settingsWidget);
        tcpPortEdit->setObjectName("tcpPortEdit");
        ...
        serialRadio->setObjectName("serialRadio");
        ...
        retriesLabel->setObjectName("retriesLabel");
        ...
        tcpRadio->setObjectName("tcpRadio");
        ...
        retriesSpin->setObjectName("retriesSpin");
        ...
        fcSerialLabel->setObjectName("fcSerialLabel");
        ...
        fcSerialDrop->addItem(QString());
        fcSerialDrop->addItem(QString());
        fcSerialDrop->setObjectName("fcSerialDrop");
        ...
        pduSerialLabel->setObjectName("pduSerialLabel");
        ...
        pduSerialLine->setObjectName("pduSerialLine");

        gridLayout_7->addWidget(pduSerialLine, 2, 1, 1, 2);

        verticalSpacer_7 = new QSpacerItem(20, 163, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);

        gridLayout_7->addItem(verticalSpacer_7, 3, 1, 1, 1);

        addressSpin = new QSpinBox(groupBox);
        addressSpin->setObjectName("addressSpin");
        ...
        tiLine->setObjectName("tiLine");
        tiLine->setFrameShape(QFrame::Shape::HLine);
        tiLine->setFrameShadow(QFrame::Shadow::Sunken);
        ...
        ti1Label->setObjectName("ti1Label");
        ...
        piLine->setObjectName("piLine");
        piLine->setFrameShape(QFrame::Shape::HLine);
        piLine->setFrameShadow(QFrame::Shadow::Sunken);
        ...
        pi1Label->setObjectName("pi1Label");
        ...
        lLine->setObjectName("lLine");
        lLine->setFrameShape(QFrame::Shape::HLine);
        lLine->setFrameShadow(QFrame::Shadow::Sunken);
        ...
        ui1Label->setObjectName("ui1Label");
        ...
        fcTcpLabel->setObjectName("fcTcpLabel");
        ...
        fcTcpDrop->addItem(QString());
        fcTcpDrop->addItem(QString());
        fcTcpDrop->setObjectName("fcTcpDrop");
        ...
        pduTcpLabel->setObjectName("pduTcpLabel");
        ...
        pduTcpLine->setObjectName("pduTcpLine");
        ...
        QObject::connect(tcpRadio, &QRadioButton::toggled, tcpPortEdit, &QLineEdit::setEnabled);
        QObject::connect(tcpRadio, &QRadioButton::toggled, tcpAddressEdit, &QLineEdit::setEnabled);
        QObject::connect(serialRadio, &QRadioButton::toggled, serialPortLabel, &QLabel::setEnabled);
        QObject::connect(tcpRadio, &QRadioButton::toggled, tcpPortLabel, &QLabel::setEnabled);
        QObject::connect(tcpRadio, &QRadioButton::toggled, tcpAddressLabel, &QLabel::setEnabled);
        QObject::connect(connectButton, &QPushButton::clicked, connectButton, &QPushButton::setEnabled);
        QObject::connect(connectButton, &QPushButton::clicked, disconnectButton, &QPushButton::setDisabled);
        QObject::connect(disconnectButton, &QPushButton::clicked, connectButton, &QPushButton::setDisabled);
        QObject::connect(disconnectButton, &QPushButton::clicked, disconnectButton, &QPushButton::setEnabled);
        QObject::connect(connectButton, &QPushButton::clicked, settingsWidget, &QWidget::setEnabled);
        QObject::connect(disconnectButton, &QPushButton::clicked, settingsWidget, &QWidget::setDisabled);
        QObject::connect(disconnectButton, &QPushButton::clicked, sendButton, &QPushButton::setEnabled);
        QObject::connect(connectButton, &QPushButton::clicked, sendButton, &QPushButton::setDisabled);
        QObject::connect(serialRadio, &QRadioButton::toggled, serialPortCombo, &QComboBox::setEnabled);
        QObject::connect(serialRadio, &QRadioButton::toggled, parityLabel, &QLabel::setEnabled);
        QObject::connect(serialRadio, &QRadioButton::toggled, dataBitsLabel, &QLabel::setEnabled);
        QObject::connect(serialRadio, &QRadioButton::toggled, stopBitsLabel, &QLabel::setEnabled);
        QObject::connect(serialRadio, &QRadioButton::toggled, baudRateLabel, &QLabel::setEnabled);
        QObject::connect(serialRadio, &QRadioButton::toggled, parityCombo, &QComboBox::setEnabled);
        QObject::connect(serialRadio, &QRadioButton::toggled, dataBitsCombo, &QComboBox::setEnabled);
        QObject::connect(serialRadio, &QRadioButton::toggled, stopBitsCombo, &QComboBox::setEnabled);
        QObject::connect(serialRadio, &QRadioButton::toggled, baudRateCombo, &QComboBox::setEnabled);
        QObject::connect(actionClear, &QAction::triggered, logTextEdit, qOverload<>(&PlainTextEdit::clear));
        QObject::connect(actionSelect_All, &QAction::triggered, logTextEdit, qOverload<>(&PlainTextEdit::selectAll));
        QObject::connect(actionCopy, &QAction::triggered, logTextEdit, qOverload<>(&PlainTextEdit::copy));
        QObject::connect(actionSelect_All, &QAction::triggered, logTextEdit, qOverload<>(&PlainTextEdit::setFocus));
