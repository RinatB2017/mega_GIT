...
void B590_toolbar::init(void)
{
    ...
    connect(c1, SIGNAL(currentIndexChanged(int)), this, SLOT(currentIndexChanged(int)));
    connect(btn_run, SIGNAL(released()), this, SLOT(run()));
...
void B590_toolbar::currentIndexChanged(int index)
{
    ...
    case 7:
        c2->clear();
        c2->addItem(B590_CMD_0x70_TEXT, QVariant(Qt::UserRole + B590_CMD_0x70));
