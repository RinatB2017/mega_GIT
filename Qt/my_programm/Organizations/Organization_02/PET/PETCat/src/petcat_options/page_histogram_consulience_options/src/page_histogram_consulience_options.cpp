...
#include "ui_page_histogram_consulience_options.h"
//--------------------------------------------------------------------------------
#include "pet_defines.hpp"
//--------------------------------------------------------------------------------
Page_histogram_consulience_options::Page_histogram_consulience_options(QWidget *parent) :
    MyWidget(parent),
    ui(new Ui::Page_histogram_consulience_options)
{
    init();
}
//--------------------------------------------------------------------------------
Page_histogram_consulience_options::~Page_histogram_consulience_options()
{
    delete ui;
}
//--------------------------------------------------------------------------------
void Page_histogram_consulience_options::init(void)
{
    ui->setupUi(this);
...
//--------------------------------------------------------------------------------
void Page_histogram_consulience_options::t_accept(void)
{
...
//--------------------------------------------------------------------------------
void Page_histogram_consulience_options::color_p(void)
{
    QToolButton *tb = dynamic_cast<QToolButton *>(sender());
    if(tb == nullptr)
    {
        emit error("Page_histogram_consulience_options: error sender");
        return;
    }
...
//--------------------------------------------------------------------------------
void Page_histogram_consulience_options::color_gauss(void)
{
    QToolButton *tb = dynamic_cast<QToolButton *>(sender());
    if(tb == nullptr)
    {
...
//--------------------------------------------------------------------------------
void Page_histogram_consulience_options::block_wheel(void)
{
...
//--------------------------------------------------------------------------------
bool Page_histogram_consulience_options::eventFilter(QObject*, QEvent* event)
{
