...
void TestBox_2::init(void)
{
    ...
    connect(ui->btn_send_info,  SIGNAL(clicked(bool)),  this,   SLOT(send_info()));
    connect(ui->btn_send_debug, SIGNAL(clicked(bool)),  this,   SLOT(send_debug()));
    connect(ui->btn_send_error, SIGNAL(clicked(bool)),  this,   SLOT(send_error()));
    connect(ui->btn_send_trace, SIGNAL(clicked(bool)),  this,   SLOT(send_trace()));
...
//--------------------------------------------------------------------------------
void TestBox_2::send_info(void)
{
    emit info("info");
}
//--------------------------------------------------------------------------------
void TestBox_2::send_debug(void)
{
    emit debug("debug");
}
//--------------------------------------------------------------------------------
void TestBox_2::send_error(void)
{
    emit error("error");
}
//--------------------------------------------------------------------------------
void TestBox_2::send_trace(void)
{
    emit trace("trace");
}
//--------------------------------------------------------------------------------
