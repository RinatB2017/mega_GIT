...
private slots:
    ...
    void slot_correct_action(void);

    void statistic(void);

    //---
    void btn_all_on_click(void);
    void btn_all_off_click(void);
    void btn_Options_click(void);
    void btn_Clear_click(void);
    void btn_Load_click(void);
    void btn_Save_click(void);
    void btn_Horizontal_click(bool state);
    void btn_Vertical_click(bool state);
    void btn_Statistic_click(void);
    //---
