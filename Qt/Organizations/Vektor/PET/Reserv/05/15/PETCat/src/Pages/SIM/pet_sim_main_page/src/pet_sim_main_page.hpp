...
**********************************************************************************/
#ifndef PET_SIM_MAIN_PAGE_HPP
#define PET_SIM_MAIN_PAGE_HPP
//--------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------
namespace Ui {
    class PET_sim_main_page;
}
//--------------------------------------------------------------------------------
class Transceiver;
//--------------------------------------------------------------------------------
class PET_sim_main_page : public PET_device_sim
{
    Q_OBJECT

public:
    explicit PET_sim_main_page(QWidget *parent, bool is_demo = false);
    ~PET_sim_main_page();
