...
**********************************************************************************/
#ifndef V788_MULTIMETER_HPP
#define V788_MULTIMETER_HPP
//--------------------------------------------------------------------------------
...
#endif
//--------------------------------------------------------------------------------
#define MULTIMETER_NAME    "Мультиметр В7-88"
//--------------------------------------------------------------------------------
;
#pragma pack (push, 1)
//--------------------------------------------------------------------------------
...
{
    E_V788_NO_ERROR = 0,
    E_V788_ERROR_INDEX_NOT_CORRECT,
    E_V788_ERROR_PORT_NOT_OPEN,
    E_V788_ERROR_BREAK,
    E_V788_ERROR_MAX_REPEAT,
    E_V788_ERROR_NO_ANSWER,
    E_V788_ERROR_BIG_ANSWER,
    E_V788_ERROR_SMALL_ANSWER,
    E_V788_ERROR_BAD_SERNO,
    E_V788_ERROR_BAD_ADDRESS,
    E_V788_ERROR_BAD_COMMAND,
    E_V788_ERROR_BAD_CRC,
    E_V788_ERROR_BAD_LEN,
    E_V788_ERROR_UNKNOWN_COMMAND,
    E_V788_ERROR_SIZE_NOT_CORRECT,
    E_V788_UNKNOWN_ERROR,
    E_V788_INVALID_FLOAT,
    E_V788_INVALID_LIMIT,
    E_V788_INVALID_DELTA,
    E_V788_BREAK_MEASURING,
    E_V788_ILLEGAL_FUNCTION,
    E_V788_ILLEGAL_DATA_VALUE,
    E_V788_OVERLOAD,
    E_V788_LO_FREQ
};
enum MODE {
...
//--------------------------------------------------------------------------------
class Multimeter_V788 : public MyWidget
{
    Q_OBJECT

public:
    explicit Multimeter_V788(QWidget *parent = nullptr);
    virtual ~Multimeter_V788();
...
#else
    SerialPort_V788_test *serial = nullptr;
#endif
