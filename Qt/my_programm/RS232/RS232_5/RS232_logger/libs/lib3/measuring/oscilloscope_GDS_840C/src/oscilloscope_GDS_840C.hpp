...
public:
    explicit Oscilloscope_GDS_840C(QWidget *parent = nullptr);
...
private:
    ...
    void prepare_channels_hscale(void);
    void set_hscale(void);
    void get_hscale(void);

    void prepare_channel_A(void);
    void set_vscale_A(void);
    void get_vscale_A(void);

    void prepare_channel_B(void);
    void set_vscale_B(void);
    void get_vscale_B(void);
