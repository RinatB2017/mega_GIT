...
//--------------------------------------------------------------------------------
bool Imitator_BRG::dev_open(bool is_silence)
{
#define MAX_STR 255
...
//--------------------------------------------------------------------------------
bool Imitator_BRG::is_open(void)
{
    return (dev != 0);
}
//--------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------
bool Imitator_BRG::ReadTemperature(float *temperature)
{
    if(dev == NULL)
    {
        emit error("handle not created");
    ...
    *temperature = (float)((output_buf[3] + (output_buf[4] << 8)) / 100.0);
    return true;
}
//--------------------------------------------------------------------------------
