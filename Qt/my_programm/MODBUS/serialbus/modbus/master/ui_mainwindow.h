...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        readAddress->setObjectName(QStringLiteral("readAddress"));
        ...
        readSize->addItem(QString());
        readSize->addItem(QString());
        readSize->setObjectName(QStringLiteral("readSize"));
        ...
        readValue->setObjectName(QStringLiteral("readValue"));
        ...
        writeGroupBox->setObjectName(QStringLiteral("writeGroupBox"));
        ...
        writeValueTable->setObjectName(QStringLiteral("writeValueTable"));
        ...
        writeAddress->setObjectName(QStringLiteral("writeAddress"));
        ...
        writeSize->addItem(QString());
        writeSize->addItem(QString());
        writeSize->setObjectName(QStringLiteral("writeSize"));
        ...
        writeTable->setObjectName(QStringLiteral("writeTable"));
