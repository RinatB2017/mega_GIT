...
**********************************************************************************/
#ifndef V780_PACKETS_HPP
#define V780_PACKETS_HPP
//--------------------------------------------------------------------------------
;
#pragma pack (push, 1)
//--------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------
struct CMD_V780_0x41_QUESTION
{
    V780_HEADER header;
    unsigned short crc16;
};

struct CMD_V780_0x41_ANSWER
{
    V780_HEADER header;
    unsigned short crc16;
};
//--------------------------------------------------------------------------------
struct CMD_V780_0x42_QUESTION
{
    V780_HEADER header;
    unsigned char  baud;
    unsigned char  time;
...
//--------------------------------------------------------------------------------
struct CMD_V780_0x45_QUESTION
{
    V780_HEADER header;
    unsigned short crc16;
};

struct CMD_V780_0x45_ANSWER
{
    V780_HEADER header;
    unsigned short crc16;
};
//--------------------------------------------------------------------------------
struct CMD_V780_0x46_QUESTION
{
    V780_HEADER header;
    unsigned short crc16;
};

struct CMD_V780_0x46_ANSWER
{
    V780_HEADER header;
    unsigned char  type;
    unsigned char  year;
...
//--------------------------------------------------------------------------------
struct CMD_V780_0x47_QUESTION
{
    V780_HEADER header;
    unsigned short crc16;
};

struct CMD_V780_0x47_ANSWER
{
    V780_HEADER header;
    unsigned char  state;
    unsigned char  error;
...
struct CMD_V780_0x53_ANSWER_ERROR
{
    V780_HEADER header;
    unsigned char error;
    unsigned short crc16;
