...
bool Calibration_channel::set(pet_brg_ch_calibration data)
{
    ...
    ui->sb_readout_temp_get_offset->setValue(data.readout_temp_get_offset);
    ui->sb_readout_temp_get_gain->setValue(data.readout_temp_get_gain);
    ui->sb_ifmodule_temp_get_offset->setValue(data.ifmodule_temp_get_offset);
    ui->sb_ifmodule_temp_get_gain->setValue(data.ifmodule_temp_get_gain);
...
bool Calibration_channel::get(pet_brg_ch_calibration *data)
{
    ...
    (*data).readout_temp_get_offset = ui->sb_readout_temp_get_offset->value();
    (*data).readout_temp_get_gain = ui->sb_readout_temp_get_gain->value();
    (*data).ifmodule_temp_get_offset = ui->sb_ifmodule_temp_get_offset->value();
    (*data).ifmodule_temp_get_gain = ui->sb_ifmodule_temp_get_gain->value();
