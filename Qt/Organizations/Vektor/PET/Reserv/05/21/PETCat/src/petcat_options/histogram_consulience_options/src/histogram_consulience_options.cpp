...
void Histogram_consulience_options::init(void)
{
    ...
    o->get_histogram_consulience_option(PARAM_histogram_consulience_flags,           &f_value);
...
void Histogram_consulience_options::t_accept(void)
{
    ...
    o->set_histogram_consulience_option(PARAM_histogram_consulience_flags,           value);
    o->deleteLater();
