...
QT_MOC_LITERAL(1, 12, 8), // "gotEvent"
QT_MOC_LITERAL(2, 21, 0) // ""

    },
    "EventWidget\0gotEvent\0"
};
...
void EventWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        EventWidget *_t = static_cast<EventWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->gotEvent((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (EventWidget::*_t)(const QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EventWidget::gotEvent)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject EventWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_EventWidget.data,
      qt_meta_data_EventWidget,  qt_static_metacall, nullptr, nullptr}
};
