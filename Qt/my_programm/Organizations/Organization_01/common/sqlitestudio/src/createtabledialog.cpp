...
void CreateTableDialog::on_cmdAddField_clicked(void)
{
...
void CreateTableDialog::on_cmdDeleteField_clicked(void)
{
    ui->tblFields->removeRow(ui->tblFields->currentRow());
}

QString CreateTableDialog::getSQL(void)
{
...
void CreateTableDialog::on_buttonBox_accepted(void)
{
    if (isAlter)
    {
...
void CreateTableDialog::on_buttonBox_rejected(void)
{
    this->reject();
}
