...
//--------------------------------------------------------------------------------
void PET_td_main_page::btn_refresh_click(void)
{
    main_refresh();
}
//--------------------------------------------------------------------------------
void PET_td_main_page::btn_apply_click(void)
{
    main_apply();
}
//--------------------------------------------------------------------------------
void PET_td_main_page::btn_close_click(void)
{
    main_close();
}
//--------------------------------------------------------------------------------
void PET_td_main_page::btn_import_click(void)
{
    f_import();
}
//--------------------------------------------------------------------------------
void PET_td_main_page::btn_export_click(void)
{
    f_export();
}
//--------------------------------------------------------------------------------
