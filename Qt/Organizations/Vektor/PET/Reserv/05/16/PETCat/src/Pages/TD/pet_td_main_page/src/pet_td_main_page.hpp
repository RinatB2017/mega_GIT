...
**********************************************************************************/
#ifndef PET_TD_MAIN_PAGE_HPP
#define PET_TD_MAIN_PAGE_HPP
//--------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------
namespace Ui {
    class PET_td_main_page;
}
//--------------------------------------------------------------------------------
class Transceiver;
//--------------------------------------------------------------------------------
class PET_td_main_page : public PET_device_td
{
    Q_OBJECT

public:
    explicit PET_td_main_page(QWidget *parent, bool is_demo = false);
    ~PET_td_main_page();
