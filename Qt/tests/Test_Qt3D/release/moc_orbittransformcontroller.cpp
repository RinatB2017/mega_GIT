...
void OrbitTransformController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OrbitTransformController::targetChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (OrbitTransformController::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OrbitTransformController::radiusChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (OrbitTransformController::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OrbitTransformController::angleChanged)) {
                *result = 2;
                return;
            }
        }
...
void *OrbitTransformController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OrbitTransformController.stringdata0))
        return static_cast<void*>(const_cast< OrbitTransformController*>(this));
