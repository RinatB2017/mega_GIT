...
#include "pet_errno.h"
//--------------------------------------------------------------------------------
Device_SIM::Device_SIM(QObject *parent) : Device_base(parent)
{
    init();
}
//--------------------------------------------------------------------------------
void Device_SIM::init(void)
{
    connect_log();
    ...
    sim_func_list.append(&Device_SIM::f_PET_CMD_SET_CONTROL);
    sim_func_list.append(&Device_SIM::f_PET_CMD_GET_CONTROL);
    sim_func_list.append(&Device_SIM::f_PET_CMD_SET_CH_CONTROL);
    sim_func_list.append(&Device_SIM::f_PET_CMD_GET_CH_CONTROL);
    sim_func_list.append(&Device_SIM::f_PET_CMD_GET_STATE);
    sim_func_list.append(&Device_SIM::f_PET_CMD_GET_CH_STATE);
    sim_func_list.append(&Device_SIM::f_PET_CMD_UPDATE);
...
//--------------------------------------------------------------------------------
void Device_SIM::connect_log(void)
{
#ifdef NO_LOG
...
//--------------------------------------------------------------------------------
PET_RESULT Device_SIM::check(QByteArray input_packet, QByteArray *output_packet)
{
    ...
    foreach (sim_func f0, sim_func_list)
    {
        PET_RESULT res = PET_ERR_NONE;
        res = (this->*f0)(input_packet, output_packet);
        if(res == PET_SUCCESS)
...
//--------------------------------------------------------------------------------
PET_RESULT Device_SIM::f_PET_CMD_SET_CONTROL(QByteArray input_packet,
                                             QByteArray *output_packet)
{
    ...
    if(i_frame->len != sizeof(pet_sim_ctrl_t))
    {
...
//--------------------------------------------------------------------------------
PET_RESULT Device_SIM::f_PET_CMD_GET_CONTROL(QByteArray input_packet,
                                             QByteArray *output_packet)
{
    Q_CHECK_PTR(output_packet);
    if(output_packet == nullptr)
...
//--------------------------------------------------------------------------------
PET_RESULT Device_SIM::f_PET_CMD_GET_STATE(QByteArray input_packet,
                                           QByteArray *output_packet)
{
    Q_CHECK_PTR(output_packet);
    if(output_packet == nullptr)
...
//--------------------------------------------------------------------------------
PET_RESULT Device_SIM::f_PET_CMD_GET_CH_STATE(QByteArray input_packet,
                                              QByteArray *output_packet)
{
    Q_CHECK_PTR(output_packet);
    if(output_packet == nullptr)
...
//--------------------------------------------------------------------------------
PET_RESULT Device_SIM::f_PET_CMD_GET_CH_CONTROL(QByteArray input_packet,
                                                QByteArray *output_packet)
{
    Q_CHECK_PTR(output_packet);
    if(output_packet == nullptr)
...
//--------------------------------------------------------------------------------
PET_RESULT Device_SIM::f_PET_CMD_SET_CH_CONTROL(QByteArray input_packet,
                                                QByteArray *output_packet)
{
    Q_CHECK_PTR(output_packet);
    if(output_packet == nullptr)
...
//--------------------------------------------------------------------------------
PET_RESULT Device_SIM::f_PET_CMD_UPDATE(QByteArray input_packet,
                                        QByteArray *output_packet)
{
    Q_CHECK_PTR(output_packet);
    if(output_packet == nullptr)
...
//--------------------------------------------------------------------------------
void Device_SIM::set_net_address(QHostAddress value)
{
    if(value.isNull())
    {
        return;
...
//--------------------------------------------------------------------------------
QHostAddress Device_SIM::get_net_address(void)
{
    UINT32_BYTES temp;
...
//--------------------------------------------------------------------------------
void Device_SIM::set_net_mask(quint32 value)
{
    UINT32_BYTES temp;
    temp.value = value;
...
//--------------------------------------------------------------------------------
void Device_SIM::set_net_gateway(quint32 value)
{
    UINT32_BYTES temp;
    temp.value = value;
...
//--------------------------------------------------------------------------------
void Device_SIM::set_event_address(QHostAddress value)
{
    if(value.isNull())
    {
        return;
...
//--------------------------------------------------------------------------------
QHostAddress Device_SIM::get_event_address(void)
{
    UINT32_BYTES temp;
...
//--------------------------------------------------------------------------------
void Device_SIM::set_mac_address(uint8_t mac_0,
                                 uint8_t mac_1,
                                 uint8_t mac_2,
                                 uint8_t mac_3,
                                 uint8_t mac_4,
...
//--------------------------------------------------------------------------------
QString Device_SIM::get_str_mac_address(void)
{
...
//--------------------------------------------------------------------------------
void Device_SIM::set_cmd_port(quint16 value)
{
    cmd_port = value;
}
//--------------------------------------------------------------------------------
quint16 Device_SIM::get_cmd_port(void)
{
    return cmd_port;
}
//--------------------------------------------------------------------------------
void Device_SIM::set_event_port(quint16 value)
{
    event_port = value;
}
//--------------------------------------------------------------------------------
quint16 Device_SIM::get_event_port(void)
{
    return event_port;
}
//--------------------------------------------------------------------------------
void Device_SIM::set_pet_address(uint8_t value)
{
    pet_address = value;
}
//--------------------------------------------------------------------------------
uint8_t Device_SIM::get_pet_address(void)
{
    return pet_address;
}
//--------------------------------------------------------------------------------
