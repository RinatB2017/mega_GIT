/****************************************************************************
** Meta object code from reading C++ file 'freemesh.h'
**
...
#include "src/freemesh.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'freemesh.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 5, 15), // "showTetrahedron"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 8), // "showCone"
QT_MOC_LITERAL(4, 31, 8) // "openMesh"

    },
    "Plot\0showTetrahedron\0\0showCone\0openMesh"
};
...
void Plot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->showTetrahedron(); break;
        case 1: _t->showCone(); break;
...
const QMetaObject Plot::staticMetaObject = {
    { &MPlot::staticMetaObject, qt_meta_stringdata_Plot.data,
...
void *Plot::qt_metacast(const char *_clname)
{
    ...
    return MPlot::qt_metacast(_clname);
}

int Plot::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = MPlot::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 3)
