...
#include "ui_page_imitator_brg_options.h"
//--------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------
Page_imitator_BRG_options::Page_imitator_BRG_options(QWidget *parent) :
    MyWidget(parent),
    ui(new Ui::Page_imitator_BRG_options)
{
    init();
}
//--------------------------------------------------------------------------------
Page_imitator_BRG_options::~Page_imitator_BRG_options()
{
    delete ui;
}
//--------------------------------------------------------------------------------
void Page_imitator_BRG_options::init(void)
{
    ui->setupUi(this);
...
//--------------------------------------------------------------------------------
void Page_imitator_BRG_options::block_wheel(void)
{
...
//--------------------------------------------------------------------------------
void Page_imitator_BRG_options::t_accept(void)
{
