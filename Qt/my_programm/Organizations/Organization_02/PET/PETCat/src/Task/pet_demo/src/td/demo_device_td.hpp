...
**********************************************************************************/
#ifndef DEVICE_TD_HPP
#define DEVICE_TD_HPP
//--------------------------------------------------------------------------------
...
#include "pet_errno.h"
//--------------------------------------------------------------------------------
class Device_TD : public Device_base
{
    Q_OBJECT
public:
    explicit Device_TD(QObject *parent);
...
private:
    typedef PET_RESULT (Device_TD::*td_func)(QByteArray, QByteArray*);
    typedef PET_RESULT (Device_base::*base_func)(QByteArray, QByteArray*);
    QList<td_func>      td_func_list;
    ...
    pet_td_ctrl_t       control;
    pet_td_ch_ctrl_t    ch_ctrl;
};
//--------------------------------------------------------------------------------
#endif // DEVICE_TD_HPP
