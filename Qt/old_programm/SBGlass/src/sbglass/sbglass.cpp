    ...
    , flagInfoTextBlockEnabled_(true)
{
    ...
    defaultMovie_ = new QMovie(":/SBGlass/1627.gif", QByteArray(), wAnimationContainer_);
}
...
{
    QGraphicsOpacityEffect qe;
    wGlass_->setGraphicsEffect(&qe);
}
...
void SBGlass::setMovie(QMovie* movie)
{
    ...
    {
        QMovie qm;
        wAnimationContainer_->setMovie(&qm);
    }
