...
**********************************************************************************/
#ifndef V764_1_SERIALPORT_TEST_HPP
#define V764_1_SERIALPORT_TEST_HPP
//--------------------------------------------------------------------------------
...
#endif
//--------------------------------------------------------------------------------
class SerialPort_V764_1_test : public QObject
{
    Q_OBJECT

public:
    explicit SerialPort_V764_1_test(QObject *parent = nullptr);
    virtual ~SerialPort_V764_1_test();
