...
void show_leds(void)
{
  controllers[0]->show(matrix0, leds_per_strip[0], data_t.memory_t.gBrightness);
  controllers[1]->show(matrix1, leds_per_strip[1], data_t.memory_t.gBrightness);
  controllers[2]->show(matrix2, leds_per_strip[2], data_t.memory_t.gBrightness);
  controllers[3]->show(matrix3, leds_per_strip[3], data_t.memory_t.gBrightness);
  controllers[4]->show(matrix4, leds_per_strip[4], data_t.memory_t.gBrightness);
  controllers[5]->show(matrix5, leds_per_strip[5], data_t.memory_t.gBrightness);
  controllers[6]->show(matrix6, leds_per_strip[6], data_t.memory_t.gBrightness);
  controllers[7]->show(matrix7, leds_per_strip[7], data_t.memory_t.gBrightness);
  controllers[8]->show(matrix8, leds_per_strip[8], data_t.memory_t.gBrightness);
}
//---------------------------------------------------------------
