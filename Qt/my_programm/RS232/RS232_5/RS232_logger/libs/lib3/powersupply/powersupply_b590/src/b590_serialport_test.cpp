...
void SerialPort_B590_test::init_fram(void)
{
    ...
    connect(fram, &B590_Fram::info,     this,   &SerialPort_B590_test::info);
    connect(fram, &B590_Fram::debug,    this,   &SerialPort_B590_test::debug);
    connect(fram, &B590_Fram::error,    this,   &SerialPort_B590_test::error);
    connect(fram, &B590_Fram::trace,    this,   &SerialPort_B590_test::trace);
...
void SerialPort_B590_test::create_fake_toolbar(void)
{
    ...
    connect(btn_R1, &QPushButton::clicked,
            this,   &SerialPort_B590_test::set_R1);
    connect(btn_R2, &QPushButton::clicked,
            this,   &SerialPort_B590_test::set_R2);
    ...
    connect(btn_set_noice,  &QPushButton::clicked,
            this,           &SerialPort_B590_test::regenerate_all);
    ...
    connect(timer,  &QTimer::timeout,
            this,   &SerialPort_B590_test::update);
    timer->start(1000);
}
//--------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------
bool SerialPort_B590_test::setStopBits(QSerialPort::StopBits)
{
    return true;
}
//--------------------------------------------------------------------------------
bool SerialPort_B590_test::setParity(QSerialPort::Parity)
{
    return true;
}
//--------------------------------------------------------------------------------
bool SerialPort_B590_test::setDataBits(QSerialPort::DataBits)
{
    return true;
}
//--------------------------------------------------------------------------------
bool SerialPort_B590_test::setFlowControl(QSerialPort::FlowControl)
{
    return true;
}
//--------------------------------------------------------------------------------
bool SerialPort_B590_test::clear(void)
{
    return true;
}
//--------------------------------------------------------------------------------
...
void SerialPort_B590_test::prepare_answer_46(void)
{
    ...
    answer.body.crc16 = CRC::powersupply_crc16((unsigned char *)&answer.buf,
...
//        answer.body.data.hour    = point.hour;
//        answer.body.data.min    = point.min;
        answer.body.data.sec    = point.sec;
    }
...
void SerialPort_B590_test::prepare_answer_5E(void)
{
    ...
    point.hour    = 0; //question->body.data.hour;
    point.min     = 0; //question->body.data.min;
    point.sec     = question->body.data.sec;
    ...
    answer.body.data.voltage = point.voltage;
    answer.body.data.current = point.current;
    answer.body.data.sec     = point.hour*3600 + point.min*60 + point.sec;
...
void SerialPort_B590_test::secret_CMD_READ_FRAM_MORE_BYTES(void)
{
    ...
    //emit message(QString("output %1").arg(output.toHex().data()));
    emit readyRead();
}
//--------------------------------------------------------------------------------
...
void SerialPort_B590_test::secret_CMD_SAVE_FRAM_MORE_BYTES(void)
{
    ...
    save_fram_more_bytes.data.address = 1;
    save_fram_more_bytes.data.data_len = len;
    for(unsigned int n=0; n<len; n++)
    {
        fram->write_data_8(address+n, question->body.data.secret_data[n]);
        save_fram_more_bytes.data.fram_data[n] = question->body.data.secret_data[n];
    }
