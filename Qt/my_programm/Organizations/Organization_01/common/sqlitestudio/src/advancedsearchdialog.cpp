...
void AdvancedSearchDialog::on_cmdAddtoSearch_clicked(void)
{
...
QString AdvancedSearchDialog::generateSQL(void)
{
...
void AdvancedSearchDialog::on_buttonBox_accepted(void)
{
    searchQuery = generateSQL();
    this->accept();
}

void AdvancedSearchDialog::on_buttonBox_rejected(void)
{
    this->reject();
}
