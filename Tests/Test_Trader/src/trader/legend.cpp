...
void Legend::renderLegend(QPainter *painter, const QRectF &rect, bool fillBackground) const
{
    ...
    const QStandardItemModel *mdl = qobject_cast<const QStandardItemModel *>( d_treeView->model());
...
{
    const QStandardItemModel *model = qobject_cast<QStandardItemModel *>( d_treeView->model() );
