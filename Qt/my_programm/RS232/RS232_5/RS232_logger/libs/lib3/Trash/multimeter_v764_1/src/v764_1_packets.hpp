...
//--------------------------------------------------------------------------------
struct CMD_V7642_0x41_QUESTION
{
    V7642_HEADER header;
    uint16_t crc16;
};

struct CMD_V7642_0x41_ANSWER
{
    V7642_HEADER header;
    uint16_t crc16;
};
//--------------------------------------------------------------------------------
struct CMD_V7642_0x42_QUESTION
{
    V7642_HEADER header;
    uint8_t  baud;
    uint8_t  time;
...
struct CMD_V7642_0x42_ANSWER
{
    V7642_HEADER header;
    uint16_t crc16;
};
//--------------------------------------------------------------------------------
struct CMD_V7642_0x45_QUESTION
{
    V7642_HEADER header;
    uint16_t crc16;
};

struct CMD_V7642_0x45_ANSWER
{
    V7642_HEADER header;
    uint16_t crc16;
};
//--------------------------------------------------------------------------------
struct CMD_V7642_0x46_QUESTION
{
    V7642_HEADER header;
    uint16_t crc16;
};

struct CMD_V7642_0x46_ANSWER
{
    V7642_HEADER header;
    uint8_t  type;
    uint8_t  year;
...
//--------------------------------------------------------------------------------
struct CMD_V7642_0x47_QUESTION
{
    V7642_HEADER header;
    uint16_t crc16;
};

struct CMD_V7642_0x47_ANSWER
{
    V7642_HEADER header;
    uint8_t  state;
    uint8_t  error;
...
//--------------------------------------------------------------------------------
struct CMD_V7642_0x48_QUESTION
{
    V7642_HEADER header;
    uint8_t  data_0;
    uint16_t crc16;
...
//--------------------------------------------------------------------------------
struct CMD_V7642_0x53_QUESTION
{
    V7642_HEADER header;
    uint8_t  data_0;
    uint16_t crc16;
...
struct CMD_V7642_0x53_ANSWER_ERROR
{
    V7642_HEADER header;
    uint8_t error;
    uint16_t crc16;
