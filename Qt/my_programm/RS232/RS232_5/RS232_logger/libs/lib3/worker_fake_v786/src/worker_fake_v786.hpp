...
**********************************************************************************/
#ifndef WORKER_FAKE_V786_HPP
#define WORKER_FAKE_V786_HPP
//--------------------------------------------------------------------------------
#ifdef HAVE_QT5
#   include <QtWidgets>
#else
...
//--------------------------------------------------------------------------------
namespace Ui {
    class Worker_fake_v786;
}
//--------------------------------------------------------------------------------
class Worker_fake_v786 : public QWidget
{
    Q_OBJECT
...
public:
    explicit Worker_fake_v786(QWidget *parent = nullptr);
    ~Worker_fake_v786();
