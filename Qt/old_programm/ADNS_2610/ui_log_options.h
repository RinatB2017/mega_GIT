...
public:
    ...
    QCheckBox *cb_Auto_Load;
    QHBoxLayout *horizontalLayout;
    QCheckBox *cb_Auto_Save;
    QLineEdit *lineEdit;
    QFrame *frame_2;
    ...
    void setupUi(QDialog *Log_options)
    {
        ...
        cb_Auto_Load = new QCheckBox(frame_3);
        cb_Auto_Load->setObjectName(QStringLiteral("cb_Auto_Load"));

        verticalLayout_6->addWidget(cb_Auto_Load);

        horizontalLayout = new QHBoxLayout();
        horizontalLayout->setObjectName(QStringLiteral("horizontalLayout"));
        cb_Auto_Save = new QCheckBox(frame_3);
        cb_Auto_Save->setObjectName(QStringLiteral("cb_Auto_Save"));

        horizontalLayout->addWidget(cb_Auto_Save);
    ...
    {
        Log_options->setWindowTitle(QApplication::translate("Log_options", "Form", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("Log_options", "TextEdit", Q_NULLPTR));
        cb_readOnly->setText(QApplication::translate("Log_options", "readOnly", Q_NULLPTR));
        cb_acceptRichText->setText(QApplication::translate("Log_options", "acceptRichText", Q_NULLPTR));
        cb_NoCRLF->setText(QApplication::translate("Log_options", "no CRLF", Q_NULLPTR));
        cb_add_DateTime->setText(QApplication::translate("Log_options", "add DateTime", Q_NULLPTR));
        cb_Color->setText(QApplication::translate("Log_options", "color", Q_NULLPTR));
        cb_ErrorAsMessage->setText(QApplication::translate("Log_options", "Error as Message", Q_NULLPTR));
        cb_Text_Is_Windows->setText(QApplication::translate("Log_options", "is windows", Q_NULLPTR));
        cb_Auto_Load->setText(QApplication::translate("Log_options", "auto load", Q_NULLPTR));
        cb_Auto_Save->setText(QApplication::translate("Log_options", "auto save", Q_NULLPTR));
        lineEdit->setText(QApplication::translate("Log_options", "log.html", Q_NULLPTR));
        groupBox_2->setTitle(QApplication::translate("Log_options", "Codecs", Q_NULLPTR));
        label_2->setText(QApplication::translate("Log_options", "CodecForCStrings", Q_NULLPTR));
    } // retranslateUi
