...
#include "ui_pet_sim_main_page.h"
#include "defines.hpp"
#include "pet.h"
//--------------------------------------------------------------------------------
#ifdef QT_DEBUG
...
#endif
//--------------------------------------------------------------------------------
PET_sim_main_page::PET_sim_main_page(QWidget *parent, bool is_demo) :
    PET_device_sim(parent),
    ui(new Ui::PET_sim_main_page),
    flag_is_demo(is_demo)
{
    init();
}
//--------------------------------------------------------------------------------
PET_sim_main_page::~PET_sim_main_page()
{
...
//--------------------------------------------------------------------------------
void PET_sim_main_page::update_widgets(void)
{
    main_refresh();
}
//--------------------------------------------------------------------------------
//--------------------------------------------------------------------------------
void PET_sim_main_page::main_refresh(void)
{
...
//--------------------------------------------------------------------------------
void PET_sim_main_page::main_apply(void)
{
    block_this_button(true);
...
//--------------------------------------------------------------------------------
void PET_sim_main_page::main_close(void)
{
    emit error("Close");
    parentWidget()->close();
}
//--------------------------------------------------------------------------------
//--------------------------------------------------------------------------------
void PET_sim_main_page::add_page_p_device_info(void)
{
...
//--------------------------------------------------------------------------------
void PET_sim_main_page::add_page_p_net_config(void)
{
...
//--------------------------------------------------------------------------------
void PET_sim_main_page::init(void)
{
    ui->setupUi(this);
...
//--------------------------------------------------------------------------------
void PET_sim_main_page::btn_refresh_click(void)
{
    main_refresh();
}
//--------------------------------------------------------------------------------
void PET_sim_main_page::btn_apply_click(void)
{
    main_apply();
}
//--------------------------------------------------------------------------------
void PET_sim_main_page::btn_close_click(void)
{
    main_close();
}
//--------------------------------------------------------------------------------
void PET_sim_main_page::btn_import_click(void)
{
    f_import();
}
//--------------------------------------------------------------------------------
void PET_sim_main_page::btn_export_click(void)
{
    f_export();
}
//--------------------------------------------------------------------------------
void PET_sim_main_page::all_refresh(void)
{
    f_PET_CMD_GET_DEVICE_INFO();
    //f_PET_CMD_GET_STATE();
    f_PET_CMD_GET_CONTROL();
...
//--------------------------------------------------------------------------------
void PET_sim_main_page::get_packet(QByteArray packet)
{
...
//--------------------------------------------------------------------------------
PET_RESULT PET_sim_main_page::f_PET_CMD_GET_DEVICE_INFO(void)
{
...
//--------------------------------------------------------------------------------
PET_RESULT PET_sim_main_page::f_PET_CMD_GET_CONTROL(void)
{
...
//--------------------------------------------------------------------------------
PET_RESULT PET_sim_main_page::f_PET_CMD_SET_CONTROL(void)
{
...
//--------------------------------------------------------------------------------
void PET_sim_main_page::block_this_button(bool state)
{
...
//--------------------------------------------------------------------------------
void PET_sim_main_page::block_interface(QWidget *widget, bool state)
{
    if(!widget)
    {
        return;
...
//--------------------------------------------------------------------------------
bool PET_sim_main_page::check_packet(uint8_t cmd, QByteArray packet)
{
    //emit debug(QString("check_size_packet: [%1]").arg(packet.toHex().data()));
    if(packet.length() < (int)sizeof(pet_frame_t))
    {
        emit error("PET_sim_main_page::check_size_packet: packet too small");
        return false;
    }
    ...
    {
        emit error("PET_sim_main_page::check_size_packet: bad len");
        return false;
    }
...
//--------------------------------------------------------------------------------
//FIXME костыль
void PET_sim_main_page::f_import(void)
{
    PET_device_sim::f_import();
}
void PET_sim_main_page::f_export(void)
{
    PET_device_sim::f_export();
}
//--------------------------------------------------------------------------------
