...
#pragma pack(pop)
//--------------------------------------------------------------------------------
#define SIZE_DATA 3 // 2 байта контрольной суммы + 1 байт канала
//--------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------
class Multimeter_V786_2 : public QObject
{
    Q_OBJECT
...
public:
    ...
    bool find_wired_device(QString *port_name);
...
#ifdef FAKE
    void set_fake_address(uint8_t value);
    void set_fake_channel(uint8_t value);
    void set_fake_serno(uint16_t value);
    void set_fake_year(uint16_t value);
#endif
    ...
    bool enabling_charge(void);
    bool disabling_charge(void);
    bool request_settings_charge(void);
    bool get_ID(void);
    bool wired_off(void);
    bool get_state(void);
...
public slots:
    ...
    bool check_wired_multimeter(void);
    ...
    int run_dialog_0x18(void);
    int run_dialog_0x19(void);
    int run_dialog_0x1A(void);
