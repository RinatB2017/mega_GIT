...
//--------------------------------------------------------------------------------
void Main_options::is_shows_info(bool state)
{
    flag_is_shows_info = state;
    emit signal_is_shows_info(state);
}
//--------------------------------------------------------------------------------
void Main_options::is_shows_debug(bool state)
{
    flag_is_shows_debug = state;
    emit signal_is_shows_debug(state);
}
//--------------------------------------------------------------------------------
void Main_options::is_shows_error(bool state)
{
    flag_is_shows_error = state;
    emit signal_is_shows_error(state);
}
//--------------------------------------------------------------------------------
void Main_options::is_shows_trace(bool state)
{
