...
void Test::check_bos(void)
{
    ...
    bos->set_comm_param(get_eth_address(),
...
void Test::check_brg(void)
{
    ...
    brg->set_comm_param(get_eth_address(),
                        PETCat_options::get_port_cmd());
    brg->set_pet_addr(1);
...
void Test::check_sim(void)
{
    ...
    sim->set_comm_param(get_eth_address(),
                        PETCat_options::get_port_cmd());
    sim->set_pet_addr(0);
...
void Test::check_td(void)
{
    ...
    td->set_comm_param(get_eth_address(),
                       PETCat_options::get_port_cmd());
    td->set_pet_addr(0);
...
void Test::check_brg_sim(void)
{
    ...
    brg_sim->set_comm_param(get_eth_address(),
                            PETCat_options::get_port_cmd());
