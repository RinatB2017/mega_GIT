...
#include "ui_page_histogram_energy_options.h"
//--------------------------------------------------------------------------------
#include "pet_defines.hpp"
#include "defines.hpp"
//--------------------------------------------------------------------------------
Page_histogram_energy_options::Page_histogram_energy_options(QWidget *parent) :
    MyWidget(parent),
    ui(new Ui::Page_histogram_energy_options)
{
    init();
}
//--------------------------------------------------------------------------------
Page_histogram_energy_options::~Page_histogram_energy_options()
{
    delete ui;
}
//--------------------------------------------------------------------------------
void Page_histogram_energy_options::init(void)
{
    ui->setupUi(this);
...
//--------------------------------------------------------------------------------
void Page_histogram_energy_options::t_accept(void)
{
...
//--------------------------------------------------------------------------------
void Page_histogram_energy_options::color_histogramm(void)
{
...
//--------------------------------------------------------------------------------
void Page_histogram_energy_options::block_wheel(void)
{
...
//--------------------------------------------------------------------------------
bool Page_histogram_energy_options::eventFilter(QObject*, QEvent* event)
{
