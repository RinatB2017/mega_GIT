...
**********************************************************************************/
#ifndef V780_SERIALPORT_TEST_HPP
#define V780_SERIALPORT_TEST_HPP
//--------------------------------------------------------------------------------
...
#endif
//--------------------------------------------------------------------------------
class SerialPort_V780_test : public QObject
{
    Q_OBJECT

public:
    explicit SerialPort_V780_test(QObject *parent = nullptr);
    virtual ~SerialPort_V780_test();
