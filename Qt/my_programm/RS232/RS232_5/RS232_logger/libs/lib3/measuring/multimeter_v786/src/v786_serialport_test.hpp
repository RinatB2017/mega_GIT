...
**********************************************************************************/
#ifndef V786_SERIALPORT_TEST_HPP
#define V786_SERIALPORT_TEST_HPP
//--------------------------------------------------------------------------------
#include <QtGlobal>
#ifdef Q_OS_LINUX
#   include <stdint.h>
...
#include <QObject>
//--------------------------------------------------------------------------------
class SerialPort_V786_test : public QObject
{
    Q_OBJECT

public:
    explicit SerialPort_V786_test(QObject *parent = nullptr);
    ~SerialPort_V786_test();
