...
#define NAME_UPDATE_FIRMWARE        "Обновление ПО"
...
//--------------------------------------------------------------------------------
    ...
    //#define HOME_DIR    "~/Programming/my_programm_bin/Vektor/PETCat/"
...
#define PARAM_histogram_consulience_flags           "histogram_consulience_flags"
#define DEFAULT_PARAM_histogram_consulience_flags   0xfe
