...
void SerialPort_V780_test::create_fake_toolbar(void)
{
    ...
    connect(cb_hand_value,  &QCheckBox::toggled,
            this,           &SerialPort_V780_test::hand_data);
    connect(sb_value,       &QSpinBox::editingFinished,
            this,           &SerialPort_V780_test::regenerate_value);
...
//--------------------------------------------------------------------------------
void SerialPort_V780_test::input(const QByteArray &data)
{
    write(data);
}
//--------------------------------------------------------------------------------
void SerialPort_V780_test::get_test_value(void)
{
...
//--------------------------------------------------------------------------------
bool SerialPort_V780_test::serial_open(void)
{
    return open(1);
}
//--------------------------------------------------------------------------------
void SerialPort_V780_test::serial_close(void)
{
    is_open = false;
}
//--------------------------------------------------------------------------------
void SerialPort_V780_test::setPortName(QString)
{

}
//--------------------------------------------------------------------------------
QStringList SerialPort_V780_test::get_port_names(void)
{
    QStringList sl;
    sl << "TEST";
...
//--------------------------------------------------------------------------------
void SerialPort_V780_test::write(const QByteArray &data)
{
...
//--------------------------------------------------------------------------------
void SerialPort_V780_test::print_log(const QString &text)
{
    QString temp;
    temp.append("### Б7-80: ");
    temp.append(text);
...
//--------------------------------------------------------------------------------
void SerialPort_V780_test::print_err_log(const QString &text)
{
    QString temp;
    temp.append("### Б7-80: ");
    temp.append(text);
...
{
    CMD_V780_0x45_QUESTION *question = (CMD_V780_0x45_QUESTION *)ba_input.data();
...
{
    CMD_V780_0x46_QUESTION *question = (CMD_V780_0x46_QUESTION *)ba_input.data();
...
{
    CMD_V780_0x47_QUESTION *question = (CMD_V780_0x47_QUESTION *)ba_input.data();
...
{
    CMD_V780_0x48_QUESTION *question = (CMD_V780_0x48_QUESTION *)ba_input.data();
...
{
    CMD_V780_0x53_QUESTION *question = (CMD_V780_0x53_QUESTION *)ba_input.data();
...
void SerialPort_V780_test::prepare_answer_45(void)
{
    ...
    answer.header.cmd = V780_CMD_0x45;
...
void SerialPort_V780_test::prepare_answer_46(void)
{
    ...
    answer.header.address = 0;
    answer.header.cmd = V780_CMD_0x46;
...
void SerialPort_V780_test::prepare_answer_47(void)
{
    ...
    answer.header.address = 0;
    answer.header.cmd = V780_CMD_0x47;
    answer.header.count_data = sizeof(answer) - sizeof(answer.header) - sizeof(answer.crc16);
...
void SerialPort_V780_test::prepare_answer_48(void)
{
    ...
    answer.header.address = 0;
    answer.header.cmd = V780_CMD_0x48;
    answer.header.count_data = sizeof(answer) - sizeof(answer.header) - sizeof(answer.crc16);
    answer.crc16 = CRC::powersupply_crc16((unsigned char *)&answer, sizeof(answer) - 2);
...
void SerialPort_V780_test::prepare_answer_53(void)
{
    ...
    answer.header.address = 0;
    answer.header.cmd = V780_CMD_0x53;
    answer.header.count_data = sizeof(answer) - sizeof(answer.header) - sizeof(answer.crc16);
