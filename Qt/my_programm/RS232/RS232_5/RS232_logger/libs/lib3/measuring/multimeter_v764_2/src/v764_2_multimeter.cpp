...
//--------------------------------------------------------------------------------
Multimeter_V764_2::Multimeter_V764_2(QWidget *parent) :
    MyWidget(parent),
    is_ready(false),
    delay_ms(1000),
    address(1)
...
Multimeter_V764_2::~Multimeter_V764_2()
{
    ...
    if(serial)
    {
        serial->serial_close();
#ifdef TEST
        disconnect(serial,  &SerialPort_V764_2_test::output,
                   this,    &Multimeter_V764_2::port_read);
#else
...
void Multimeter_V764_2::init(void)
{
    ...
    connect(serial, &SerialBox5_wo_form::info,  this,   &Multimeter_V764_2::info);
    connect(serial, &SerialBox5_wo_form::debug, this,   &Multimeter_V764_2::debug);
    connect(serial, &SerialBox5_wo_form::error, this,   &Multimeter_V764_2::error);
    connect(serial, &SerialBox5_wo_form::trace, this,   &Multimeter_V764_2::trace);
    ...
    connect(serial, &SerialBox5_wo_form::port_is_active,    this,   &Multimeter_V764_2::port_is_active);
    connect(serial, &SerialBox5_wo_form::output,            this,   &Multimeter_V764_2::port_read);
#else
    serial = new SerialPort_V764_2_test();

    connect(serial, &SerialPort_V764_2_test::info,  this,   &Multimeter_V764_2::info);
    connect(serial, &SerialPort_V764_2_test::debug, this,   &Multimeter_V764_2::debug);
    connect(serial, &SerialPort_V764_2_test::error, this,   &Multimeter_V764_2::error);
    connect(serial, &SerialPort_V764_2_test::trace, this,   &Multimeter_V764_2::trace);

    connect(serial, &SerialPort_V764_2_test::output,
            this,   &Multimeter_V764_2::port_read);
#endif
...
//--------------------------------------------------------------------------------
void Multimeter_V764_2::port_read(const QByteArray &data)
{
    if(data.isEmpty())  return;
    emit debug(QString("Multimeter_V764_2 read: [%1]").arg(data.toHex().toUpper().data()));
...
//--------------------------------------------------------------------------------
bool Multimeter_V764_2::find_device(void)
{
    QList<int> speeds;
    ...
    QString port_name = load_string(MULTIMETER_PORTNAME);
            ...
            if(ok)
            {
                if(serial->serial_open())
                {
                    ...
                    if(err == E_V764_2_NO_ERROR)
                    {
                        ...
                        save_string(MULTIMETER_PORTNAME, port_name);
...
//--------------------------------------------------------------------------------
bool Multimeter_V764_2::find_address(int begin_address, int end_address, int *r_address)
{
...
int Multimeter_V764_2::send_cmd_0x41(void)
{
    ...
    CMD_V764_2_0x41_QUESTION question;

    question.header.address = get_address();
    question.header.cmd = V764_2_CMD_0x41;
                                     ...
                                     unsigned char time)
{
    ...
    CMD_V764_2_0x42_QUESTION question;

    question.header.address = 0xFE;
    question.header.cmd = V764_2_CMD_0x42;
...
int Multimeter_V764_2::send_cmd_0x45(void)
{
    ...
    CMD_V764_2_0x45_QUESTION question;

    question.header.address = address;
    question.header.cmd = V764_2_CMD_0x45;
    question.header.count_data = 0;
    question.crc16 = CRC::powersupply_crc16((unsigned char *)&question,
                                            sizeof(question) - 2);
    ...
    int err = check_packet_answer(V764_2_CMD_0x45, sizeof(CMD_V764_2_0x45_ANSWER));
    if(err != E_V764_2_NO_ERROR)
    {
        return print_last_error();
    }

    //CMD_V764_2_0x45_ANSWER *answer = (CMD_V764_2_0x45_ANSWER *)data_multimeter.data();
...
int Multimeter_V764_2::send_cmd_0x46(void)
{
    ...
    CMD_V764_2_0x46_QUESTION question;

    question.header.address = address;
    question.header.cmd = V764_2_CMD_0x46;
    question.header.count_data = 0;
    question.crc16 = CRC::powersupply_crc16((unsigned char *)&question,
                                            sizeof(question) - 2);
    ...
    int err = check_packet_answer(V764_2_CMD_0x46, sizeof(CMD_V764_2_0x46_ANSWER));
    if(err != E_V764_2_NO_ERROR)
    {
        return last_error;
    }
    ...
    if(is_silence == false)
    {
        CMD_V764_2_0x46_ANSWER *answer = (CMD_V764_2_0x46_ANSWER *)data_multimeter.data();
...
int Multimeter_V764_2::send_cmd_0x47(int *value_uV)
{
    ...
    CMD_V764_2_0x47_QUESTION question;

    question.header.address = address;
    question.header.cmd = V764_2_CMD_0x47;
    question.header.count_data = 0;
    question.crc16 = CRC::powersupply_crc16((unsigned char *)&question,
                                            sizeof(question) - 2);
    ...
    int err = check_packet_answer(V764_2_CMD_0x47, sizeof(CMD_V764_2_0x47_ANSWER));
    if(err != E_V764_2_NO_ERROR)
    {
        return last_error;
    }

    CMD_V764_2_0x47_ANSWER *answer = (CMD_V764_2_0x47_ANSWER *)data_multimeter.data();
    ...
    *value_uV = result;
    emit debug(QString("Значение: %1").arg(result));
...
int Multimeter_V764_2::send_cmd_0x48(unsigned char new_address)
{
    ...
    CMD_V764_2_0x48_QUESTION question;

    question.header.address = 0xFE; //address;
    question.header.cmd = V764_2_CMD_0x48;
    ...
    int err = check_packet_answer(V764_2_CMD_0x48, sizeof(CMD_V764_2_0x48_ANSWER));
    if(err != E_V764_2_NO_ERROR)
    {
        return last_error;
    }

    //CMD_V764_2_0x48_ANSWER *answer = (CMD_V764_2_0x48_ANSWER *)data_multimeter.data();
...
int Multimeter_V764_2::send_cmd_0x53(unsigned char number_button_1_16)
{
    ...
    CMD_V764_2_0x53_QUESTION question;
    ...
    question.header.address = address;
    question.header.cmd = V764_2_CMD_0x53;
    ...
    int err = check_packet_answer(V764_2_CMD_0x53, sizeof(CMD_V764_2_0x53_ANSWER));
    if(err != E_V764_2_NO_ERROR)
    {
        return print_last_error();
    }
    ...
    {
        if((unsigned int)data_multimeter.length() > sizeof(CMD_V764_2_0x53_ANSWER))
        {
    ...
    {
        if((unsigned int)data_multimeter.length() > sizeof(CMD_V764_2_0x53_ANSWER_ERROR))
        {
            last_error = E_V764_2_ERROR_BIG_ANSWER;
            return last_error;
        }
        ...
        CMD_V764_2_0x53_ANSWER_ERROR *err = (CMD_V764_2_0x53_ANSWER_ERROR *)data_multimeter.data();
        emit error(QString("error %1").arg(err->error));
    }

    //CMD_V764_2_0x53_ANSWER *answer = (CMD_V764_2_0x53_ANSWER *)data_multimeter.data();
...
QMenu *Multimeter_V764_2::add_menu(void)
{
    ...
    connect(action_m_0x41, &QAction::triggered, this, &Multimeter_V764_2::run_dialog_0x41);
    connect(action_m_0x42, &QAction::triggered, this, &Multimeter_V764_2::run_dialog_0x42);
    connect(action_m_0x45, &QAction::triggered, this, &Multimeter_V764_2::run_dialog_0x45);
    connect(action_m_0x46, &QAction::triggered, this, &Multimeter_V764_2::run_dialog_0x46);
    connect(action_m_0x47, &QAction::triggered, this, &Multimeter_V764_2::run_dialog_0x47);
    connect(action_m_0x48, &QAction::triggered, this, &Multimeter_V764_2::run_dialog_0x48);
    connect(action_m_0x53, &QAction::triggered, this, &Multimeter_V764_2::run_dialog_0x53);
...
//--------------------------------------------------------------------------------
bool Multimeter_V764_2::port_is_open(void)
{
...
#ifdef USE_MIDSCALE
    int value;
    int err = send_cmd_0x47(&value);
    if(err == E_V764_2_NO_ERROR)
    {
        *value_uV = value * (65.535 / 2.5);
        return true;
    }
    return false;
#else
...
int Multimeter_V764_2::check_packet_answer(unsigned char cmd, int packet_len)
{
    ...
    CMD_V764_2_ERROR_ANSWER *answer = (CMD_V764_2_ERROR_ANSWER *)data_multimeter.constData();
...
//--------------------------------------------------------------------------------
void Multimeter_V764_2::updateText(void)
{

}
//--------------------------------------------------------------------------------
bool Multimeter_V764_2::programm_is_exit(void)
{
    return true;
}
//--------------------------------------------------------------------------------
void Multimeter_V764_2::load_setting(void)
{

}
//--------------------------------------------------------------------------------
void Multimeter_V764_2::save_setting(void)
{
