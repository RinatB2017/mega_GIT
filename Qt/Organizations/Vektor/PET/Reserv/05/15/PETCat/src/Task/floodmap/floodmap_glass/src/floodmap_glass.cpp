...
#include <QDebug>
//--------------------------------------------------------------------------------
#include "floodmap_glass.hpp"
//--------------------------------------------------------------------------------
FloodMap_glass::FloodMap_glass(QWidget *parent) :
    MyWidget(parent)
{
    center.setX(width() / 2);
...
//--------------------------------------------------------------------------------
void FloodMap_glass::install(QWidget* widget)
{
    //qDebug() << "install";
...
//--------------------------------------------------------------------------------
bool FloodMap_glass::eventFilter(QObject* object, QEvent* event)
{
    Q_UNUSED(object);
...
//--------------------------------------------------------------------------------
void FloodMap_glass::paintEvent(QPaintEvent *)
{
    QPainter painter;
    painter.begin(this);
...
//--------------------------------------------------------------------------------
void FloodMap_glass::get_circle(QPoint *c, int *r)
{
    Q_CHECK_PTR(c);
    Q_CHECK_PTR(r);
...
//--------------------------------------------------------------------------------
void FloodMap_glass::get_rect(int *x1, int *x2, int *y1, int *y2)
{
    Q_CHECK_PTR(x1);
    Q_CHECK_PTR(x2);
    Q_CHECK_PTR(y1);
