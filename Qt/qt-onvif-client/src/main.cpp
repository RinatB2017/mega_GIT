...
int main(int argc, char *argv[])
{
    ...
    Client client("http://192.168.1.88/onvif/device_service");
    ...
    DeviceManagement *dm = new DeviceManagement("http://192.168.1.88/onvif/device_service", "admin", "admin");
