...
private slots:
    ...
    //---
    bool check_current_temp(void);
    bool wait_needed_temp(void);
    bool set_testing_ui(void);
    bool measuring(void);
    bool wait_hot_temp(void);
...
private:
    ...
    QPointer<Powersupply_B590> powersupply;
