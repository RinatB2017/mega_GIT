...
void CandleStick_Box_adv::init(void)
{
    ...
    connect(ui->btn_axesX_min_inc,      &QPushButton::clicked,  this,   &CandleStick_Box_adv::axesX_min_inc);
    connect(ui->btn_axesX_max_inc,      &QPushButton::clicked,  this,   &CandleStick_Box_adv::axesX_max_inc);
    connect(ui->btn_axesX_min_dec,      &QPushButton::clicked,  this,   &CandleStick_Box_adv::axesX_min_dec);
    connect(ui->btn_axesX_max_dec,      &QPushButton::clicked,  this,   &CandleStick_Box_adv::axesX_max_dec);
    ...
    connect(ui->btn_get_axesY_value,    &QPushButton::clicked,  this,   &CandleStick_Box_adv::get_axesY_value);
    connect(ui->btn_set_axesY_value,    &QPushButton::clicked,  this,   &CandleStick_Box_adv::set_axesY_value);
...
//--------------------------------------------------------------------------------
void CandleStick_Box_adv::set_ticket_name(QString new_ticket_name)
{
...
//--------------------------------------------------------------------------------
void CandleStick_Box_adv::get_axesY_value(void)
{
    emit trace(Q_FUNC_INFO);
...
//--------------------------------------------------------------------------------
void CandleStick_Box_adv::set_axesY_value(void)
{
    emit trace(Q_FUNC_INFO);
...
//--------------------------------------------------------------------------------
void CandleStick_Box_adv::axesX_min_inc(void)
{
    emit trace(Q_FUNC_INFO);
...
//--------------------------------------------------------------------------------
void CandleStick_Box_adv::axesX_max_inc(void)
{
    emit trace(Q_FUNC_INFO);
...
//--------------------------------------------------------------------------------
void CandleStick_Box_adv::axesX_min_dec(void)
{
    emit trace(Q_FUNC_INFO);
...
//--------------------------------------------------------------------------------
void CandleStick_Box_adv::axesX_max_dec(void)
{
    emit trace(Q_FUNC_INFO);
...
//--------------------------------------------------------------------------------
void CandleStick_Box_adv::test2(void)
{
...
void CandleStick_Box_adv::wheelEvent(QWheelEvent *event)
{
