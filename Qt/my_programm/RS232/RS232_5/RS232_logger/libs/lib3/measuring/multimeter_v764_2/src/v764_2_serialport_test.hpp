...
**********************************************************************************/
#ifndef V764_2_SERIALPORT_TEST_HPP
#define V764_2_SERIALPORT_TEST_HPP
//--------------------------------------------------------------------------------
...
#endif
//--------------------------------------------------------------------------------
class SerialPort_V764_2_test : public QObject
{
    Q_OBJECT

public:
    explicit SerialPort_V764_2_test(QObject *parent = nullptr);
    virtual ~SerialPort_V764_2_test();
