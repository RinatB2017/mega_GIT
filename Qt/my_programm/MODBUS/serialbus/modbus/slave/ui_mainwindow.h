...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        connectType->addItem(QString());
        connectType->setObjectName(QStringLiteral("connectType"));
        ...
        setBusyBox->setObjectName(QStringLiteral("setBusyBox"));

        horizontalLayout->addWidget(setBusyBox);

        listenOnlyBox = new QCheckBox(centralWidget);
        listenOnlyBox->setObjectName(QStringLiteral("listenOnlyBox"));
        ...
        disc_2->setObjectName(QStringLiteral("disc_2"));
        ...
        coils_3->setObjectName(QStringLiteral("coils_3"));
        ...
        disc_4->setObjectName(QStringLiteral("disc_4"));
        ...
        inReg_4->setObjectName(QStringLiteral("inReg_4"));
        ...
        coils_5->setObjectName(QStringLiteral("coils_5"));
        ...
        coils_6->setObjectName(QStringLiteral("coils_6"));
        ...
        coils_1->setObjectName(QStringLiteral("coils_1"));
        ...
        disc_1->setObjectName(QStringLiteral("disc_1"));
        ...
        inReg_1->setObjectName(QStringLiteral("inReg_1"));
        ...
        coils_2->setObjectName(QStringLiteral("coils_2"));
        ...
        inReg_9->setObjectName(QStringLiteral("inReg_9"));
        ...
        disc_9->setObjectName(QStringLiteral("disc_9"));
        ...
        coils_7->setObjectName(QStringLiteral("coils_7"));
        ...
        disc_7->setObjectName(QStringLiteral("disc_7"));

        gridLayout_2->addWidget(disc_7, 8, 1, 1, 1);

        inReg_7 = new QLineEdit(centralWidget);
        inReg_7->setObjectName(QStringLiteral("inReg_7"));
        ...
        coils_8->setObjectName(QStringLiteral("coils_8"));
        ...
        disc_8->setObjectName(QStringLiteral("disc_8"));
        ...
        holdingRegisters->setObjectName(QStringLiteral("holdingRegisters"));

        gridLayout_2->addWidget(holdingRegisters, 0, 4, 1, 1);

        coils_0 = new QCheckBox(centralWidget);
        coils_0->setObjectName(QStringLiteral("coils_0"));
        ...
        disc_0->setObjectName(QStringLiteral("disc_0"));

        gridLayout_2->addWidget(disc_0, 1, 1, 1, 1);

        inReg_0 = new QLineEdit(centralWidget);
        inReg_0->setObjectName(QStringLiteral("inReg_0"));
        ...
        menu_Device->setObjectName(QStringLiteral("menu_Device"));
        menuToo_ls = new QMenu(menuBar);
        menuToo_ls->setObjectName(QStringLiteral("menuToo_ls"));
