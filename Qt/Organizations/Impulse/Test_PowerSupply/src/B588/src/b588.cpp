...
void B588::init(void)
{
    ...
    ui->sb_min_value_U->setMinimum(MIN_VOLTAGE_B588);
    ui->sb_min_value_U->setMaximum(MAX_VOLTAGE_B588);

    ui->sb_min_value_I->setMinimum(MIN_CURRENT_B588);
    ui->sb_min_value_I->setMaximum(MAX_CURRENT_B588);

    ui->sb_min_value_UI->setMinimum(MIN_VOLTAGE_B588);
    ui->sb_min_value_UI->setMaximum(MAX_VOLTAGE_B588);

    ui->sb_min_value_UI->setMinimum(MIN_VOLTAGE_B588);
    ui->sb_min_value_UI->setMaximum(MAX_VOLTAGE_B588);

    ui->sb_value_U->setMinimum(1);
    ui->sb_value_U->setMaximum(MAX_CURRENT_B588);

    ui->sb_value_I->setMinimum(1);
    ui->sb_value_I->setMaximum(MAX_CURRENT_B588);

    ui->sb_max_value_U->setMinimum(MIN_VOLTAGE_B588);
    ui->sb_max_value_U->setMaximum(MAX_VOLTAGE_B588);

    ui->sb_max_value_I->setMinimum(MIN_CURRENT_B588);
    ui->sb_max_value_I->setMaximum(MAX_CURRENT_B588);

    ui->sb_max_value_UI->setMinimum(MIN_VOLTAGE_B588);
    ui->sb_max_value_UI->setMaximum(MAX_VOLTAGE_B588);

    ui->sb_max_value_UI->setMinimum(MIN_VOLTAGE_B588);
    ui->sb_max_value_UI->setMaximum(MAX_VOLTAGE_B588);

    ui->sb_step_U->setMinimum(1);
    ui->sb_step_U->setMaximum(MAX_VOLTAGE_B588);

    ui->sb_step_I->setMinimum(1);
    ui->sb_step_I->setMaximum(MAX_CURRENT_B588);

    ui->sb_step_UI->setMinimum(1);
    ui->sb_step_UI->setMaximum(MAX_VOLTAGE_B588);

    ui->sb_address->setMinimum(MIN_ADDRESS_B588);
    ui->sb_address->setMaximum(MAX_ADDRESS_B588);

    ui->sb_stability_value_U->setMinimum(MIN_VOLTAGE_B588);
    ui->sb_stability_value_U->setMaximum(MAX_VOLTAGE_B588);

    ui->sb_stability_value_I->setMinimum(0);
    ui->sb_stability_value_I->setMaximum(MAX_CURRENT_B588);
...
int B588::test(void)
{
    ...
    for(float i=0.5; i<1.0; i+=0.01)
    {
        ...
        grapher->add_curve_data(curve_powersuply, abs(U - measuring_U));
...
//--------------------------------------------------------------------------------
void B588::measuring_V7862(void)
{
...
//--------------------------------------------------------------------------------
int B588::min_to_max_b588_U(int min_U,
                            int max_U,
                            int step_U,
                            int current)
{
    ...
    {
        if(flag_stop_test_triangle) return E_B588_BREAK_MEASURING;
...
//--------------------------------------------------------------------------------
int B588::min_to_max_b588_I(int min_I,
                            int max_I,
                            int step_I,
                            int voltage)
{
...
//--------------------------------------------------------------------------------
int B588::max_to_min_b588_U(int min_U,
                            int max_U,
                            int step_U,
                            int current)
{
...
//--------------------------------------------------------------------------------
int B588::max_to_min_b588_I(int min_I,
                            int max_I,
                            int step_I,
                            int voltage)
{
...
//--------------------------------------------------------------------------------
int B588::min_to_max_b588_UI(int min_value, int max_value, int step)
{
    bool ok = false;
    int value = 0;
...
//--------------------------------------------------------------------------------
int B588::max_to_min_b588_UI(int min_value, int max_value, int step)
{
    bool ok = false;
    int value = 0;
...
//--------------------------------------------------------------------------------
void B588::test_triangle_U(void)
{
    test_triangle_b588_U();
}
//--------------------------------------------------------------------------------
void B588::test_triangle_I(void)
{
    test_triangle_b588_I();
}
//--------------------------------------------------------------------------------
void B588::test_triangle_UI(void)
{
    test_triangle_b588_UI();
}
//--------------------------------------------------------------------------------
void B588::test_stability(void)
{
    test_stability_b588();
}
//--------------------------------------------------------------------------------
int B588::test_stability_b588(void)
{
    bool ok = false;
...
//--------------------------------------------------------------------------------
int B588::test_triangle_b588_U(void)
{
    bool ok = false;
    emit info(tr("Тест начат"));
...
#endif
    min_to_max_b588_U(min, max, step, current);
    max_to_min_b588_U(min, max, step, current);
...
//--------------------------------------------------------------------------------
int B588::test_triangle_b588_I(void)
{
    bool ok = false;
    emit info(tr("Тест начат"));
...
#endif
    min_to_max_b588_I(min, max, step, voltage);
    max_to_min_b588_I(min, max, step, voltage);
...
//--------------------------------------------------------------------------------
int B588::test_triangle_b588_UI(void)
{
    bool ok = false;
    emit info(tr("Тест начат"));
...
#endif
    min_to_max_b588_UI(min, max, step);
    max_to_min_b588_UI(min, max, step);
...
//--------------------------------------------------------------------------------
void B588::stop_test_triangle(void)
{
    flag_stop_test_triangle = true;
}
//--------------------------------------------------------------------------------
void B588::stop_test_stability(void)
{
    flag_stop_test_stability = true;
}
//--------------------------------------------------------------------------------
bool B588::test_in_parrot(void)
{
    bool ok;
...
//--------------------------------------------------------------------------------
bool B588::stability_in_parrot(void)
{
    bool ok;
    int temp = ui->cb_in_parrot->itemData(ui->cb_in_parrot->currentIndex(), Qt::UserRole).toInt(&ok) - Qt::UserRole;
    if(ok)
...
//--------------------------------------------------------------------------------
void B588::active_V7862(bool state)
{
