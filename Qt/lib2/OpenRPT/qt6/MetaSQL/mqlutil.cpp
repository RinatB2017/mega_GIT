...
static QRegularExpression groupRE    = QRegularExpression("(^\\s*--\\s*GROUP:\\s*)(.*)",QRegularExpression::CaseInsensitiveOption);
static QRegularExpression nameRE     = QRegularExpression("(^\\s*--\\s*NAME:\\s*)(.*)", QRegularExpression::CaseInsensitiveOption);
static QRegularExpression notesRE    = QRegularExpression("(^\\s*--\\s*NOTES:\\s*)(.*)",QRegularExpression::CaseInsensitiveOption);
static QRegularExpression dashdashRE = QRegularExpression("(^\\s*--\\s{0,8})(.*)");
