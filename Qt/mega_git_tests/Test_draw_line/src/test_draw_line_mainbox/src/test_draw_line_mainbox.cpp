...
void MainBox::init_widgets(void)
{
    ...
    connect(ui->btn_set,    &QPushButton::clicked,  this,   &MainBox::test);
    connect(ui->btn_color,  &QPushButton::clicked,  this,   &MainBox::set_color);

    connect(ui->serial_widget,  &SerialBox5::port_is_active,    ui->btn_set,    &QPushButton::setEnabled);
