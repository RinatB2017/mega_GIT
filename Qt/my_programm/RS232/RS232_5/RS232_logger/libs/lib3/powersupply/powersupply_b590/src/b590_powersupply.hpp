...
//--------------------------------------------------------------------------------
#define ERROR_E00_B590_TEXT      "E0 - низкая температура (температура < 5 градусов)"
#define ERROR_E01_B590_TEXT      "E1 - перегрев (температура > 75 градусов)"
#define ERROR_E02_B590_TEXT      "E2 - нет ответа АЦП (неответ 10 раз после 10 перезапусков каждые 160 мс) "
#define ERROR_E03_B590_TEXT      "E3 - нет опорного напряжения на АЦП (5 раз проверки status)"
#define ERROR_E04_B590_TEXT      "E4 - ошибка АЦП  (5 раз проверки status)"
#define ERROR_E05_B590_TEXT      "E5 - ошибка контрольной суммы калибровочных данных в АЦП напряжения"
#define ERROR_E06_B590_TEXT      "E6 - ошибка контрольной суммы калибровочных данных в АЦП тока"
#define ERROR_E07_B590_TEXT      "E7 - ошибка контрольной суммы калибровочных данных в ЦАП напряжения"
#define ERROR_E08_B590_TEXT      "E8 - ошибка контрольной суммы калибровочных данных в ЦАП тока"
#define ERROR_E09_B590_TEXT      "E9 - неверна калибровка АЦП напряжения"
#define ERROR_E10_B590_TEXT      "E10 - неверна калибровка АЦП тока"
#define ERROR_E11_B590_TEXT      "E11 - неверна калибровка ЦАП напряжения"
#define ERROR_E12_B590_TEXT      "E12 - неверна калибровка ЦАП тока"
#define ERROR_E13_B590_TEXT      "E13 - нет заводской калибровки напряжения или она неверна"
#define ERROR_E14_B590_TEXT      "E14 - нет заводской калибровки тока или она неверна"
#define ERROR_E15_B590_TEXT      "E15 - пропадание питания - после чтение функцией 0x46 - обнуляется"
#define ERROR_E16_B590_TEXT      "E16 - попытка записи в исполняемый профиль"
#define ERROR_E17_B590_TEXT      "E17 - неверный номер профиля"
#define ERROR_E18_B590_TEXT      "E18 - профиль пуст"
#define ERROR_E19_B590_TEXT      "E19 - неверный номер точки"
#define ERROR_E20_B590_TEXT      "E20 - превышено максимальное значение напряжения"
#define ERROR_E21_B590_TEXT      "E21 - превышено максимальное значение тока"
#define ERROR_E22_B590_TEXT      "E22 - превышено максимальное значение времени"
#define ERROR_E23_B590_TEXT      "E23 - попытка установить неверную скорость обмена"
#define ERROR_E24_B590_TEXT      "E24 - попытка включить реверс при его отсутствии"
#define ERROR_E25_B590_TEXT      "E25 - reserved"
#define ERROR_E26_B590_TEXT      "E26 - reserved"
#define ERROR_E27_B590_TEXT      "E27 - reserved"
#define ERROR_E28_B590_TEXT      "E28 - reserved"
#define ERROR_E29_B590_TEXT      "E29 - reserved"
#define ERROR_E30_B590_TEXT      "E30 - reserved"
#define ERROR_E31_B590_TEXT      "E31 - reserved"
//--------------------------------------------------------------------------------
class QSerialPort;
//--------------------------------------------------------------------------------
class Powersupply_B590 : public MyWidget
{
    Q_OBJECT

public:
    explicit Powersupply_B590(QWidget *parent = 0);
    virtual ~Powersupply_B590();
    ...
    bool get_meas_UI(int32_t  *out_voltage,
                     uint16_t *out_current,
                     int8_t   *temp,
                     uint8_t *current_point,
                     uint8_t  *active_profile);
