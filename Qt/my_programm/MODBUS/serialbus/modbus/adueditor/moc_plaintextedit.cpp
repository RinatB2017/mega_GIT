...
static constexpr auto qt_meta_stringdata_ZN13PlainTextEditE = QtMocHelpers::stringData(
    "PlainTextEdit"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13PlainTextEditE[] = {
...
Q_CONSTINIT const QMetaObject PlainTextEdit::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13PlainTextEditE.offsetsAndSizes,
    qt_meta_data_ZN13PlainTextEditE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13PlainTextEditE_t,
        // Q_OBJECT / Q_GADGET
...
void *PlainTextEdit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13PlainTextEditE.stringdata0))
