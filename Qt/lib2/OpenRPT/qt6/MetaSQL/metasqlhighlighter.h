...
class MetaSQLHighlighter : public QSyntaxHighlighter
{
  ...
  private:
    ...
    QRegularExpression _kwtest;
    QRegularExpression _extest;
    QRegularExpression _numerictest;
    QRegularExpression _wordtest;
    QRegularExpression _metasqlquotetest;
    QRegularExpression _sqlquotetest;
