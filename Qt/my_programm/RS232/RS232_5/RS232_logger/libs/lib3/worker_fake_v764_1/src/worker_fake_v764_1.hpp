...
**********************************************************************************/
#ifndef WORKER_FAKE_V764_HPP
#define WORKER_FAKE_V764_HPP
//--------------------------------------------------------------------------------
#include <QWidget>
#include <QTimer>
//--------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------
namespace Ui {
    class Worker_fake_v764;
}
//--------------------------------------------------------------------------------
class Worker_fake_v764 : public QWidget
{
    Q_OBJECT
...
public:
    explicit Worker_fake_v764(QWidget *parent = nullptr);
    virtual ~Worker_fake_v764();
